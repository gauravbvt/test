package com.mindalliance.geonames.accessor;
...
public class GeonamesAccessor extends NKFAccessorImpl {

	public GeonamesAccessor() {
	...
	public void processRequest(INKFConvenienceHelper context) throws Exception {
		...
		switch(parts.length) {
		case 3:
			// Expecting ffcpl:/geonames/<something>
			resp = context.createResponseFrom(new StringAspect("<hello>geonames</hello>"));
			//resp = context.createResponseFrom(new GeonamesAspect(new Geonames(3)));
			resp.setCacheable();
			resp.setMimeType("text/xml");
			break;
		default :
			resp = generateError(context, "Expecting path of ffcpl:/geonames/something");
		}
