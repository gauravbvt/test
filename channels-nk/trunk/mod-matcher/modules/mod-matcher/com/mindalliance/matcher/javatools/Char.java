package com.mindalliance.matcher.javatools;
...
public class Char {
  ...
  public static Map<Character,String>ampersandUnMap=new TreeMap<Character,String>();
  static {
    Object[] o=new Object[]{
      '&',"&amp;",
      '\'',"&apos;",
     ...
     for(int i=0;i<o.length;i+=2) ampersandUnMap.put((Character)o[i],(String)o[i+1]);
  }

  /** Maps HTML ampersand sequences to strings */
  public static Map<String,Character>ampersandMap=new TreeMap<String,Character>();
  static {
    Object[] o=new Object[]{
    "nbsp", (char)160,
    "iexcl", (char)161,
    ...
    "rsaquo", (char)8250,
    "euro", (char)8364};
    for(int i=0;i<o.length;i+=2) ampersandMap.put((String)o[i],(Character)o[i+1]);
  }
  ...
  public static String encodeAmpersand(char c) {
    String s;
    if(null!=(s=ampersandUnMap.get(c))) return(s);
    if(c<128 && c>=32) return(""+c);
    else return("&#"+((int)c)+";");
  }
  ...
  public static String encodePercentage(char c) {
    ...
    if(c<65) return("%"+Integer.toHexString(c).toUpperCase());
    if(c<128) return(""+c);
