package com.mindalliance.reporting.accessor;
...
public class ReportingAccessor extends NKFAccessorImpl {

	public ReportingAccessor() {
	...
	public void processRequest(INKFConvenienceHelper context) throws Exception {
		...
		switch(parts.length) {
		case 3:
			// Expecting ffcpl:/reporting/<something>
			resp = context.createResponseFrom(new StringAspect("<hello>reporting</hello>"));
			//resp = context.createResponseFrom(new ReportingAspect(new Reporting(3)));
			resp.setCacheable();
			resp.setMimeType("text/xml");
			break;
		default :
			resp = generateError(context, "Expecting path of ffcpl:/reporting/something");
		}
