package com.mindalliance.wordnet.accessor;
...
public class WordnetAccessor extends NKFAccessorImpl {

	public WordnetAccessor() {
	...
	public void processRequest(INKFConvenienceHelper context) throws Exception {
		...
		switch(parts.length) {
		case 3:
			// Expecting ffcpl:/wordnet/<something>
			resp = context.createResponseFrom(new StringAspect("<hello>wordnet</hello>"));
			//resp = context.createResponseFrom(new WordnetAspect(new Wordnet(3)));
			resp.setCacheable();
			resp.setMimeType("text/xml");
			break;
		default :
			resp = generateError(context, "Expecting path of ffcpl:/wordnet/something");
		}
