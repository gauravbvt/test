...
class Causes extends AbstractAccessor {
    ...
    def styleTemplate = [resolution: [rankdir: 'LR', fontname: 'Helvetica'],
    ...
    protected void source(INKFConvenienceHelper context) {
        use(NetKernelCategory) {
            ...
            def builder = new GraphVizBuilder(writer, styleTemplate);

            builder.digraph(name:'needResolution',template: 'resolution' ) {
                ...
                subgraph(name:'agentB', label: 'AgentB', template: 'agent') {
