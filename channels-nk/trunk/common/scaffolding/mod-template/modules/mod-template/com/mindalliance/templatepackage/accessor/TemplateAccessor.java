package com.mindalliance.@templatepackage@.accessor;
...
public class @Template@Accessor extends NKFAccessorImpl {

	public @Template@Accessor() {
	...
	public void processRequest(INKFConvenienceHelper context) throws Exception {
		...
		case 3:
			...
			//resp = context.createResponseFrom(new @Template@Aspect(new @Template@(3)));
			resp.setCacheable();
