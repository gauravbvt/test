...
<import>
    <uri>urn:com:mindalliance:session</uri>
</import>
...
WARNING <ex>
    ...
    <ex>
        ...
        <ex>
            ...
            <requestid>urn:com:mindalliance:session</requestid>
            <stack>
...
<module>
file:/usr/local/svn/channels-nk/deploy/mod-control-0.0.1.jar
</module>

<module>
file:/usr/local/svn/channels-nk/deploy/mod-session-0.0.1.jar
</module>

<module>
file:/usr/local/svn/channels-nk/deploy/mod-template-0.0.1.jar
</module>

<module>
file:/usr/local/svn/channels-nk/deploy/test-mod-template-0.0.1.jar
</module>
...
You should see "Mind-Alliance Template Library Tests". Select the Run button and make sure that you only see green test results. There should be three Mind Alliance tests run.
...
<import>
	<uri>urn:com:mindalliance:template</uri>
</import>
...
<entrypoint>
  ...
  <indexable>
    <title>Mind-Alliance Template Library Tests</title>
    <desc>Mind-Alliance Template unit-test suite</desc>
    <keywords/>
  </indexable>
  <categories>xunit</categories>
  <group>Mind-Alliance</group>
  <icon/>
</entrypoint>
...
<testlist  title="Template Accessor Unit Tests">
    <desc>
	<div>
	<b>Template</b> accessor unit tests for the <b>Mind-Alliance Template</b> lib.
	</div>
    </desc>
    <test>
