...
import com.mindalliance.channels.pages.components.plan.ModelInvolvementsPanel;
 ...
 */
public class ModelInvolvementsFloatingPanel extends AbstractFloatingMultiAspectPanel {
    ...
    public ModelInvolvementsFloatingPanel( String id, IModel<? extends Identifiable> model ) {
        super( id, model, null, INVOLVEMENTS );
    }

    public ModelInvolvementsFloatingPanel( String id, IModel<? extends Identifiable> model, String aspect ) {
...
*/
    ...
    protected Component makeAspectPanel( String aspect, Change change ) {
        if ( aspect.equals( NETWORK ) ) {
            ...
            return new ModelInvolvementsPanel( "aspect", new Model<CollaborationModel>( getCollaborationModel() ), getExpansions() );
        }
    }
