...
public class PartReportPanel extends Panel {
    ...
    private void init() {
        ...
        add(new Label("location", part.getLocation().toString()) );
        ...
        while( outcomes.hasNext()) sends.add(outcomes.next());
        ...
        while( requirements.hasNext()) receives.add(requirements.next());
