 ...
 * An announcement know by what user it has been acknowledged and/or dismissed.
 * @author jf
 *
 */
public abstract class Announcement extends AbstractElement {
	
	private Pattern<User> audience; // Who this announcement is meant for
	private Date timestamp;
	private User createdBy; // null if system
	private Element about;
	private List<User> acknowledgers; // Users who have acknowledged the announcement
	private List<User> dismissers; // Users who have dismissed the announcement
