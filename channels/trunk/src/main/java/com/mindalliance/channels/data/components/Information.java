 ...
 * (e.g. I only want this information if there is at least MEDIUM confidence in its accuracy).
 * 
 * @author jf
 *
 */
...
public class Information extends AbstractJavaBean implements Describable {
	...
	public class Segment {
		 ...
		 */
		public void setPrivacyConstraints(List<PrivacyConstraint> privacyConstraints) {
