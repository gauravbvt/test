 ...
 */
public final class ChannelsPage extends WebPage implements Updatable {
    /**
     ...
     * Class logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger( ChannelsPage.class );
    ...
    public ChannelsPage( PageParameters parameters ) {
     ...
     */
    public ChannelsPage( Scenario scenario ) {
     ...
     */
    public ChannelsPage( Scenario sc, Part p ) {
