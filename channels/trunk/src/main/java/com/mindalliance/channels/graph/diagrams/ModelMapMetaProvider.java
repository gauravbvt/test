 ...
 * Plan meta provider.
 */
public class ModelMapMetaProvider extends AbstractMetaProvider<Segment, SegmentRelationship> {
    ...
    public ModelMapMetaProvider( List<Segment> segments, String outputFormat, Resource imageDirectory, Analyst analyst,
