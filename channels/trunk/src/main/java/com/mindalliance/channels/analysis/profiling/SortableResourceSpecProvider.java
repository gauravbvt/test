...
public class SortableResourceSpecProvider extends SortableDataProvider<ResourceSpec> {
    ...
    /**
     * Sortable provider all known resource specs that are contacts of a given resource spec
     * @param resourceSpec a resource specification
     * @param isSelf true to restrict to contacts euqal to or narrowing resource spec
     */
    public SortableResourceSpecProvider( ResourceSpec resourceSpec, boolean isSelf ) {
        resourceSpecs = Project.getProject().getDao().findAllContacts( resourceSpec, isSelf );
        setSort( "name", true );
    }

    /**
     * Provider of all given resource specifications
     * @param resourceSpecs provided resource specifications
     */
    public SortableResourceSpecProvider( List<ResourceSpec> resourceSpecs ) {
