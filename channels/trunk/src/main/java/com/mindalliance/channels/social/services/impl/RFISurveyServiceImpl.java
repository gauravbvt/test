...
public class RFISurveyServiceImpl extends GenericSqlServiceImpl<RFISurvey, Long> implements RFISurveyService {
    ...
    public List<RFISurvey> listActive( final PlanService planService, final Analyst analyst ) {
        Session session = getSession();
        Criteria criteria = session.createCriteria( getPersistentClass() );
        criteria.add( Restrictions.eq( "planUri", planService.getPlan().getUri() ) );
        ...
        return (List<RFISurvey>) CollectionUtils.select(
                ...
                new Predicate() {
                    ...
                    public boolean evaluate( Object object ) {
                        return ((RFISurvey)object).isOngoing( planService, analyst );
                    }
                });
    }
