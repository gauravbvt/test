...
public class TimelineRichlet extends GenericRichlet {
     ...
     * Default constructor.
     */
    public TimelineRichlet() {
        super();
    }

    /**
     * Called on each browser display or refresh.
     * @param page the zk page
     */
    public void service( Page page ) {
        page.setTitle( "Timeline test" );

        final ScenarioTimeline timeline =
            new ScenarioTimeline( 300, new IconManager(), page, null );
        ...
        final OccurEvent<String> e2 = new OccurEvent<String>();
        ...
        button.addEventListener( "onClick", new EventListener() {
            ...
            public void onEvent( Event arg0 ) {
                ...
                OccurEvent<String> event = new OccurEvent<String>();
                event.setText( "New Event" );
                event.setData( "New Event" );
                event.setDescription(
                    "<a href='/channels/zk/test'>Mx Graph test</a>" );
        ...
        button.addEventListener( "onClick", new EventListener() {
            ...
            public void onEvent( Event arg0 ) {
                ...
                for ( int inx = 0; inx < selected.length; inx++ ) {
                    timeline.removeOccurEvent( timeline.getOccurEvents().get(
                            selected[inx] ) );
                }
        ...
        graph.setStyle(
            "overflow:hidden; background:url('/channels/images/grid.gif');" );
