 ...
 * Time: 7:45:54 PM
 */
public class SortableIssuesProvider extends SortableDataProvider<Issue> {

    private List<Issue> issues;

    public SortableIssuesProvider( ModelObject modelObject ) {
        issues = Project.getProject().findAllIssuesFor( modelObject );
