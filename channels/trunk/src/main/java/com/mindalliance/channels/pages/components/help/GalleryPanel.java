...
public class GalleryPanel extends AbstractUpdatablePanel {
    ...
    static {
        ...
        planner_groups.add( new GalleryGroup( "Collaboration templates" )
                .add( "segmentMap", "Segment map", "The segment map shows all segments that compose a collaboration template. A segment is a template module dealing with one scenario. The segment map shows how segments are inter-connected." )
                .add( "flowMap", "Information flow map", "An information flow map shows how tasks in the segment of a collaboration template are connected by information flows, and how they relate to events and goals (risk to be mitigated and gains to be made)." )
                ...
                .add( "taxonomy", "Taxonomy", "Taxonomy diagrams show how concepts used in the definition of a collaboration template (roles, organization types etc.) are used to categorize one another." )
                ...
                .add( "network", "Collaboration network", "A collaboration network summarizes how organizations, roles or agents would, according to a collaboration template, be inter-connected by information sharing commitments." )
