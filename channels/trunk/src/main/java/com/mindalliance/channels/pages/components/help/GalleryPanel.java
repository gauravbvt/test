...
public class GalleryPanel extends AbstractUpdatablePanel {
    ...
    static {
        ...
        planner_groups.add( new GalleryGroup( "Domain collaboration plans" )
                ...
                .add( "flowMap", "Information flow map", "An information flow map shows how tasks in the segment of a plan are connected by information flows, and how they relate to events and goals (risk to be mitigated and gains to be made)." )
                ...
                .add( "network", "Collaboration network", "A collaboration network summarizes how organizations, roles or agents would, according to a plan, be inter-connected by information sharing commitments." )
        ...
        planner_groups.add( new GalleryGroup( "Plan communities" )
                ...
                .add( "checklistsReport", "Checklists", "Each participant in a plan community has access to checklists generated from the plan on the basis of the participant's current roles and responsibilities in member organizations. A checklist describes what triggers a task assignable to the participant, the steps, including the sharing of information, by which the task is to be carried out, and it provides the contact information of all involved with this task.")
        );
