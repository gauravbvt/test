...
public interface AttachmentManager {
     ...
     */
    Iterator<Attachment> attachments( long id );
     ...
     */
    void attach( long id, Attachment.Type type, FileUpload fileUpload );
     ...
     * @param url the URL
     */
    void attach( long id, Attachment.Type type, URL url );
     ...
     */
    void detach( long id, Attachment attachment );

    /**
     * Detach all attachment from an object.
     * @param id a model object id
     */
    void detachAll( long id );
}
