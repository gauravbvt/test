...
import com.mindalliance.channels.pages.components.plan.ModelEventsPanel;
 ...
 * Time: 3:47 PM
 */
public class ModelEventsAndPhasesFloatingPanel extends AbstractFloatingCommandablePanel {

    private ModelEventsPanel modelEventsPanel;

    private AjaxTabbedPanel<ITab> tabbedPanel;

    public ModelEventsAndPhasesFloatingPanel( String id, IModel<Event> eventModel ) {
        super( id, eventModel );
        init();
    }
