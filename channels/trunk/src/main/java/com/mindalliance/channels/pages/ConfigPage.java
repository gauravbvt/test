...
public class ConfigPage extends WebPage {
    ...
    private static class Config {
        ...
        private static final class SurveyConfig {
            ...
            private SurveyConfig( Properties properties ) {
                key = properties.getProperty( "surveyService.apiKey" );
                user = properties.getProperty( "surveyService.userKey" );
                email = properties.getProperty( "surveyService.defaultEmailAddress" );
                template = properties.getProperty( "surveyService.template" );
            }

            public void saveTo( Properties properties ) {
                if ( key != null )
                    properties.setProperty( "surveyService.apiKey", key );
                if ( user != null )
                    properties.setProperty( "surveyService.userKey", user );
                if ( email != null )
                    properties.setProperty( "surveyService.defaultEmailAddress", email );
                if ( template != null )
                    properties.setProperty( "surveyService.template", template );
            }
