...
abstract public class AbstractFloatingCommandablePanel extends AbstractCommandablePanel implements Guidable {
    ...
    public AbstractFloatingCommandablePanel( String id, IModel<? extends Identifiable> iModel ) {
        this( id, iModel, null );
    }


    public AbstractFloatingCommandablePanel( String id, IModel<? extends Identifiable> iModel, Set<Long> expansions ) {
