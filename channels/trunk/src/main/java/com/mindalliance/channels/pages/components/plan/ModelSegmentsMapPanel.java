...
import com.mindalliance.channels.pages.components.diagrams.ModelMapDiagramPanel;
 ...
 * Plan map panel.
 */
public class ModelSegmentsMapPanel extends AbstractUpdatablePanel {
     ...
     */
    private ModelMapDiagramPanel modelMapDiagramPanel;
    ...
    public ModelSegmentsMapPanel( String id, IModel<? extends Identifiable> model, Set<Long> expansions ) {
    ...
    private void addPlanSizing() {
        ...
        sizingLabel.add( new AbstractDiagramAjaxBehavior( DOM_IDENTIFIER, reducedToFit ) {
            ...
            protected void respond( AjaxRequestTarget target ) {
                ...
                addPlanMapDiagramPanel();
                target.add( modelMapDiagramPanel );
                addPlanSizing();
    ...
    private void addPlanMapDiagramPanel() {
        ...
        modelMapDiagramPanel = new ModelMapDiagramPanel( "model-map",
                                                       ...
                                                       selectedSgRel,
                                                       settings );
        modelMapDiagramPanel.setOutputMarkupId( true );
        addOrReplace( modelMapDiagramPanel );
    }
    ...
    public String getFlowsTitle() {
        if ( selectedGroup != null ) {
            if ( groupByPhase ) {
                return "Flows connecting model segments in phase \"" + selectedGroup.getName() + "\"";
            } else {
                return "Flows connecting model segments about event \"" + selectedGroup.getName() + "\"";
            }
        } else if ( selectedSegment != null ) {
            return "Flows connecting \"" + selectedSegment.getName() + "\" to other model segments";
    ...
    public void changed( Change change ) {
        if ( change.isSelected() ) {
            ...
            if ( changed instanceof CollaborationModel ) {
                selectedGroup = null;
