...
import com.mindalliance.channels.core.model.CollaborationModel.Status;
 ...
 */
public class ModelDefinition extends Observable {
    ...
    //---------------------------
    public ModelDefinition( String uri, String values ) {
        this( uri );
    ...
    public ModelDefinition( String uri ) {
        this.uri = uri;
    }
    ...
    public void delete() {
        try {
            ...
            LOG.debug( "Deleted data for model {}", uri );
        } catch ( IOException e ) {
    ...
    public class Version {
        ...
        public ModelDefinition getPlanDefinition() {
            return ModelDefinition.this;
        }
        ...
        public synchronized void setLastId( long id ) throws IOException {
            ...
            idFile.delete();
            LOG.debug( "Creating model lastID file at " + idFile.getAbsolutePath() );
         ...
         */
        CollaborationModel createPlan( IdGenerator idGenerator ) {
            CollaborationModel collaborationModel = new CollaborationModel();

            collaborationModel.setId( idGenerator.assignId( null, uri ) );
            collaborationModel.setName( name );
            collaborationModel.setUri( uri );
            collaborationModel.setVersion( number );
            collaborationModel.setStatus( status );
            collaborationModel.setClient( client );
