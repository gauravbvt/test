 ...
 */
public class ModelObjectLinkPanel extends ExternalLink {

    public ModelObjectLinkPanel( String id, IModel<? extends ModelObject> mo ) {
        this( id, mo, null );
    }

    public ModelObjectLinkPanel(
        ...
        super(
            ...
            new AbstractReadOnlyModel<String>() {
                ...
                public String getObject() {
                    ...
                    if ( obj != null )
                        LoggerFactory.getLogger( ModelObjectLinkPanel.class ).warn(
