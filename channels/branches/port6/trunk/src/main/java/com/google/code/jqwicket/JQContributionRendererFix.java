 ...
 * @author mkalina
 */
public class JQContributionRendererFix extends JQContributionRenderer {
    ...
    public static JQContributionRenderer get() {
        ...
        if (target == null) {
            target = new JQContributionRendererFix();
    ...
    JQContributionRendererFix() {
    }


    public JQContributionRendererFix addContributors(Collection<? extends IJQHeaderContributor> contributors) {
    ...
    public JQContributionRendererFix addContributor(IJQHeaderContributor contributor) {
