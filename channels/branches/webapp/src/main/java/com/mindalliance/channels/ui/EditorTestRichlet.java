...
import com.mindalliance.channels.data.models.Artefact;
import com.mindalliance.channels.data.models.Assertion;
import com.mindalliance.channels.data.models.Knowledge;
import com.mindalliance.channels.data.models.RoleAgent;
...
import com.mindalliance.channels.data.profiles.Channel;
...
public class EditorTestRichlet extends GenericRichlet {
    ...
    public void service(Page page) {
        ...
        addEditor(new Storyline(), w,page);
        addEditor(new Task(), w,page);
        addEditor(new RoleAgent(), w,page);
        addEditor(new com.mindalliance.channels.data.models.Event(), w,page);
        addEditor(new Repository(), w,page);
        addEditor(new OrganizationImpl(), w,page);
