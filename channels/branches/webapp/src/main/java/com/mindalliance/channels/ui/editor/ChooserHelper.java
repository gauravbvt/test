...
import com.mindalliance.channels.data.profiles.Team;
...
public class ChooserHelper {
    ...
    public Collection<Organization> findOrganization(
    ...
    public void addOrganization(
            OrganizationImpl org, SystemService system,User user ) {
    ...
    public void addUser( User org, SystemService system, User user ) {
        try {
            system.getRegistryService().registerUser( org.getName(),
                    org.getUsername(), org.getPassword() );
