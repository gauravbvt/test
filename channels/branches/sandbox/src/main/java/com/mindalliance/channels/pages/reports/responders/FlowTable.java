...
import com.mindalliance.channels.pages.reports.responders.ParticipantPage.AggregatedFlow;
import com.mindalliance.channels.pages.reports.responders.ParticipantPage.ContactSpec;
            ...
            new ListView<AggregatedFlow>( "perFlow", flows ) {
                    ...
                    protected void populateItem( ListItem<AggregatedFlow> item ) {
                        ...
                        item.add(
                            ...
                            new Label( "flowTiming", ParticipantPage.lcFirst( flow.getTiming() ) )
                            ...
                            new WebMarkupContainer( "eoisRow" )
                                .add( ParticipantPage.newEoiList( flow.getElementsOfInformation() ) )
                                .setRenderBodyOnly( true )
