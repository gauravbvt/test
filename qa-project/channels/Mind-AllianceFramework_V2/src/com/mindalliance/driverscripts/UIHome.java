...
//
//import com.mindalliance.configuration.Browsers;
//import com.mindalliance.configuration.Configuration;
//import com.mindalliance.configuration.DataLocators;
...
//			jListView = new JList();
//			DefaultListModel listModel = new DefaultListModel();
//			arrayOfTestCaseId = DataLocators.readTestCaseId(1);
//			for (int i=0;i<GlobalVariables.Index;i++)
//			{
...
//			jListPlan = new JList();
//			DefaultListModel listModel = new DefaultListModel();
//			arrayOfTestCaseId = DataLocators.readTestCaseId(2);
//			for (int i = 0; i <GlobalVariables.Index ; i++ ) 
//				listModel.addElement(arrayOfTestCaseId[i]);
...
//			arrayOfTestCaseId = DataLocators.readTestCaseId(3);
//			for (int i = 0; i <GlobalVariables.Index; i++)
//				listModel.addElement(arrayOfTestCaseId[i]);
...
//			// Initialize browser
//			Browsers.createFirefoxBrowserInstance();
////			GlobalVariables.configuration = Configuration.getConfigurationObject();
...
//					cls = Class.forName("com.mindalliance.uitestscripts." + testCaseId);
//					cls.newInstance();
//					//Update progressBar
//					cnt = cnt + 1;
...
//					File file = new File("D://Mind-AllianceFramework_V2//Reports//GlobalVariables.Index.htm");
