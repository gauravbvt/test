 ...
 *
 */
public class CollaborationPlansPage {
	
	String fileName = "CollaborationPlans.xml";
	...
	*/
	 ...
	 * @throws UIAutomationException 
	*/
	public void clickSignOutButton() throws UIAutomationException{
		elementController.requireElementSmart(fileName,"Sign Out On Collaboration Plans Page",GlobalVariables.configuration.getAttrSearchList(), "Sign Out On Collaboration Plans Page");
		UIActions.click(fileName,"Sign Out On Collaboration Plans Page",GlobalVariables.configuration.getAttrSearchList(), "Sign Out On Collaboration Plans Page");
