...
public class MAV0153_viewSocialPanelHideBroadCast 
{
	public MAV0153_viewSocialPanelHideBroadCast()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0153_viewSocialPanelHideBroadCast";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0153_viewSocialPanelHideBroadCast();
