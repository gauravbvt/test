...
public class MAV0199_AddInfoReceiveSendInformation 
{
	public MAV0199_AddInfoReceiveSendInformation(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0199_AddInfoReceiveSendInformation";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Infomation"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
				...
				// Enter Information Details of 'Add info received' 
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Information Details Entered";				
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0199_AddInfoReceiveSendInformation();
