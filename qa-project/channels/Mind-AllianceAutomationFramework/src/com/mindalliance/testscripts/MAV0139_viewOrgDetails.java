...
public class MAV0139_viewOrgDetails 
{
	public MAV0139_viewOrgDetails()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0139_viewOrgDetails";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Organizations details";
				...
				// Assertion: Verify that "Organizations details" page loaded 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Organiztions details' page gets loaded";
