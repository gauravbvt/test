...
public class MAV0152_viewSocialPanelShowReceivedMessage 
{
	public MAV0152_viewSocialPanelShowReceivedMessage()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0152_viewSocialPanelShowReceivedMessage";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0152_viewSocialPanelShowReceivedMessage();
