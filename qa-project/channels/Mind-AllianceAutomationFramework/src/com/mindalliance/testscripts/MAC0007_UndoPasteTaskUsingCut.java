 ...
 * 
 */
public class MAC0007_UndoPasteTaskUsingCut {
	public MAC0007_UndoPasteTaskUsingCut() {
		try {
			GlobalVariables.sTestCaseId = "MAC0007_UndoPasteTaskUsingCut";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Undo Paste Task Using Cut"), "New");
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
				    ...
				    for(WebElement option : options) {
				    	if("Segment For Undo Paste Task Using Cut".equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0007_UndoPasteTaskUsingCut();
