...
public class MAV0094_goalUnderAboutPlanSegment
{
	public MAV0094_goalUnderAboutPlanSegment()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0094_goalUnderAboutPlanSegment";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Goals' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
			    ...
			    // Assertion: Verify that page loaded with heading "Goals" 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Goals' gets loaded on the About Plan Segment window";		            		         
			    GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.assertion.get("sXpathAssertionGoals")));			    
			    if (GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("goalsForThisSegment"))) {
			    	 // Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0094_goalUnderAboutPlanSegment();
