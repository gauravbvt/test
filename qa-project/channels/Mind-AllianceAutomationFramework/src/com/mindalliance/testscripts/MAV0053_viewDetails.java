...
/**
 * TestCase ID: MAV0053_viewDetails
 * Summary: Verify that page loaded with heading "Details"
 * @author: AFour
 *
 */
	...
	public MAV0053_viewDetails()
	{
		try{
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("Details"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Assertion: Verify that page loaded with heading "Details" 
			    GlobalVariables.iStepNo++;
