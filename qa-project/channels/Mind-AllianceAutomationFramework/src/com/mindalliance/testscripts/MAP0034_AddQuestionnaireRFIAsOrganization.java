...
public class MAP0034_AddQuestionnaireRFIAsOrganization {
	public MAP0034_AddQuestionnaireRFIAsOrganization() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0034_AddQuestionnaireRFIAsOrganization";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Organization'";
			    ...
			    for(WebElement option : options) {
			    	if("organization".equals(option.getText())){
			    			option.setSelected();
				...
				// Assertion: Verify that the RFI For 'Organization' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'organization'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Organization")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Organizaton' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0034_AddQuestionnaireRFIAsOrganization();
