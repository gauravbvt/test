...
public class MAV0216_AddInfoReceiveActionPopUpMenu 
{
	public MAV0216_AddInfoReceiveActionPopUpMenu(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0216_AddInfoReceiveActionPopUpMenu";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("action"))){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Action' "+" Actual " + GlobalVariables.oElement;
			    	// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0216_AddInfoReceiveActionPopUpMenu();
