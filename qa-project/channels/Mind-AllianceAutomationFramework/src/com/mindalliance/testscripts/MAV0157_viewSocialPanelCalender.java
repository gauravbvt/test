...
public class MAV0157_viewSocialPanelCalender 
{
	public MAV0157_viewSocialPanelCalender(){
		try{			
			GlobalVariables.sTestCaseId = "MAV0157_viewSocialPanelCalender";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on Calendar tab on social panel
				...
				if (GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("calendar"))) {
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected "+GlobalVariables.viewElements.get("calendar")+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0157_viewSocialPanelCalender();
