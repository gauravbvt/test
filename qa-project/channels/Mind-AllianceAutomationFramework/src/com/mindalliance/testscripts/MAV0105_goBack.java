...
public class MAV0105_goBack
{
	public MAV0105_goBack(){
		
			try {
				GlobalVariables.sTestCaseId = "MAV0105_goBack";
				...
				if (GlobalVariables.bIsSuccess) {
				    ...
				    // Assertion: Verify that the previously loaded window is displayed
				    GlobalVariables.iStepNo++;
				    GlobalVariables.sDescription="Verify that the previously loaded window is displayed";
