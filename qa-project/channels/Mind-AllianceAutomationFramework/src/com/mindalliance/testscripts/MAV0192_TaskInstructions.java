...
public class MAV0192_TaskInstructions 
{
	public MAV0192_TaskInstructions(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0192_TaskInstructions";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(2000);
				// Assertion : Verify that Instruction Details are Entered Successfully
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("segment:part:description"));
