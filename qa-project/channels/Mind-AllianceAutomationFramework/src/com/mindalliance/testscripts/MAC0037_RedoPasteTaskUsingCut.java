 ...
 * 
 */
public class MAC0037_RedoPasteTaskUsingCut {
	public MAC0037_RedoPasteTaskUsingCut() {
		try {
			GlobalVariables.sTestCaseId = "MAC0037_RedoPasteTaskUsingCut";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Redo Paste Task Using Cut"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Click 'Redo paste task' option under 'Actions' pop up menu
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Redo paste task done";
				ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathActionsPopUpMenu"),GlobalVariables.viewElements.get("redoPasteTask"));
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(3000);
			    ...
			    for(WebElement option : options) {
			    	if(GlobalVariables.testData.get("Segment For Redo Paste Task Using Cut").equals(option.getText())){
			    			option.setSelected();
			    			break;
			    	}
			    }
				...
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				System.out.println("Unable to Redo Paste Task Using Cut" + ReportFunctions.getScreenShot("Redo Paste Task Using Cut failed"));
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0037_RedoPasteTaskUsingCut();
