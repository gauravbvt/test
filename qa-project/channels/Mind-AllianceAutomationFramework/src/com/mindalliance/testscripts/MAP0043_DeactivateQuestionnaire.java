...
public class MAP0043_DeactivateQuestionnaire {
	public MAP0043_DeactivateQuestionnaire() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0043_DeactivateQuestionnaire";
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0043_DeactivateQuestionnaire();
