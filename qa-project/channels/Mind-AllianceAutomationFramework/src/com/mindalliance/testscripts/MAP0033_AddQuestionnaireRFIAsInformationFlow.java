...
public class MAP0033_AddQuestionnaireRFIAsInformationFlow {
	public MAP0033_AddQuestionnaireRFIAsInformationFlow() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0033_AddQuestionnaireRFIAsInformationFlow";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Information Flows'";
			    ...
			    for(WebElement option : options) {
			    	if("information flows".equals(option.getText())){
			    			option.setSelected();
				...
				// Assertion: Verify that the RFI For 'Information Flow' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'information flow'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Information Flows")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Information Flows' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0033_AddQuestionnaireRFIAsInformationFlow();
