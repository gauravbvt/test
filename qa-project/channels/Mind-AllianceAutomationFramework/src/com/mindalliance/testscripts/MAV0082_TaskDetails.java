...
public class MAV0082_TaskDetails
{
	public MAV0082_TaskDetails() {
		try {
			GlobalVariables.sTestCaseId = "MAV0082_TaskDetails";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				//Clicks on 'details' link under show pop up menu option 	
				GlobalVariables.iStepNo++ ;
