 ...
 * Summary: Verify that Attachment can be added from the Event of the Segment
 * @author AfourTech
 *
 */
public class MAP0020_addFileToEvent
{
	public MAP0020_addFileToEvent() {
		try {
			GlobalVariables.sTestCaseId = "MAP0020_addFileToEvent";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Add File To Event"));
			    ...
			    for(WebElement option : options) {
			    	if(option.getText().equals(GlobalVariables.testData.get("Segment For Add File To Event"))){
			    			option.setSelected();
			    			break;
			    	}
			    }
				...
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				System.out.println("Unable to Add File to Event" + ReportFunctions.getScreenShot("Add File to Event failed"));
