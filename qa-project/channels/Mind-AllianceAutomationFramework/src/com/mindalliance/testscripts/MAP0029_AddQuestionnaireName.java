...
public class MAP0029_AddQuestionnaireName {
	public MAP0029_AddQuestionnaireName() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0029_AddQuestionnaireName";
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0029_AddQuestionnaireName();
