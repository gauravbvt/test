 ...
 *
 */
public class MAV0089_viewActionsPopup 
{
	public MAV0089_viewActionsPopup() {
		try {
			GlobalVariables.sTestCaseId = "MAV0089_viewActionsPopup";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathTaskActionsMenu"))).click();
