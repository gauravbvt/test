...
/**
 * TestCase Id: MAV0065_viewVersions
 * Summary: Verify that "Versions" page loaded
 * @author: AFour
 *
 */
public class MAV0065_viewVersions 
{
	public MAV0065_viewVersions()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0065_viewVersions";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Versions' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Versions section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("versions"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Assertion: Verify that page loaded with heading "Versions" 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Versions' gets loaded on the About Plan Segment window";		            		         
