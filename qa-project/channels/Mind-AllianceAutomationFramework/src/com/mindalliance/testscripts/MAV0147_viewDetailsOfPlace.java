...
public class MAV0147_viewDetailsOfPlace 
{
	public MAV0147_viewDetailsOfPlace()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0147_viewDetailsOfPlace";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Places details";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0147_viewDetailsOfPlace();
