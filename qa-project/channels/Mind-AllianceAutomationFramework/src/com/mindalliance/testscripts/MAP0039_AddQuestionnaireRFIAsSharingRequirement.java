...
public class MAP0039_AddQuestionnaireRFIAsSharingRequirement {
	public MAP0039_AddQuestionnaireRFIAsSharingRequirement() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0039_AddQuestionnaireRFIAsSharingRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Sharing requirements'";
			    ...
			    for(WebElement option : options) {
			    	if("sharing requirements".equals(option.getText())){
			    			option.setSelected();
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Sharing Requirements' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
				...
				// Assertion: Verify that the RFI For 'Sharing requirements' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Sharing requirements'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Sharing requirements")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0039_AddQuestionnaireRFIAsSharingRequirement();
