...
public class MAC0062_RedoAddNewRequirement
{
	public MAC0062_RedoAddNewRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "MAC0062_RedoAddNewRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Redo Add New Requirement"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0062_RedoAddNewRequirement();
