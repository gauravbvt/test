...
public class MAV0217_AddInfoSentShowPopUpMenu 
{
	public MAV0217_AddInfoSentShowPopUpMenu(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0217_AddInfoSentShowPopUpMenu";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info sent")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0217_AddInfoSentShowPopUpMenu();
