...
public class MAV0100_moveTaskUnderAction 
{
	public MAV0100_moveTaskUnderAction() {
		try {
			GlobalVariables.sTestCaseId = "MAV0100_moveTaskUnderAction";
			...
			if (GlobalVariables.bIsSuccess) {
		    	...
		    	ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathActionsPopUpMenu"),GlobalVariables.viewElements.get("moveTaskToSegment"));
		    	// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    // Assertion: Verify that window opens with title "About Plan Segment:<Name>" and heading "Task Mover"
			    GlobalVariables.iStepNo++;
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0100_moveTaskUnderAction();
