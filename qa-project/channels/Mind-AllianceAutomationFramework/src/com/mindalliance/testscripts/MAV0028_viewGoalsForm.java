...
public class MAV0028_viewGoalsForm {
	
	public MAV0028_viewGoalsForm()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0028_viewGoalsForm";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Clicks on 'Goals' link under show pop up menu option on About plan window 
				GlobalVariables.iStepNo++;
