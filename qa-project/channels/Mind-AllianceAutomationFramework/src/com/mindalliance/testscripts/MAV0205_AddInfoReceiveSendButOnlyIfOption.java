...
public class MAV0205_AddInfoReceiveSendButOnlyIfOption 
{
	public MAV0205_AddInfoReceiveSendButOnlyIfOption(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0205_AddInfoReceiveSendButOnlyIfOption";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0205_AddInfoReceiveSendButOnlyIfOption();
