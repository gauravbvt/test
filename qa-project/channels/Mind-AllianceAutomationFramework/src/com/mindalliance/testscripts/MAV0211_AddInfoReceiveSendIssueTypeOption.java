...
public class MAV0211_AddInfoReceiveSendIssueTypeOption 
{
	public MAV0211_AddInfoReceiveSendIssueTypeOption(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0211_AddInfoReceiveSendIssueTypeOption";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0211_AddInfoReceiveSendIssueTypeOption();
