...
public class MAV0189_GoalsLink 
{
	public MAV0189_GoalsLink(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0189_GoalsLink";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(2000);
				// Assertion : Verify that 'Goals' Window Opened
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.className("floating"));
				if(GlobalVariables.oElement.getText().contains(GlobalVariables.viewElements.get("goals"))) {
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);					
