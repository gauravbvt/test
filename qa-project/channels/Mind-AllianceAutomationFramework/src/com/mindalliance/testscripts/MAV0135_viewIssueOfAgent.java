...
public class MAV0135_viewIssueOfAgent
{
	public MAV0135_viewIssueOfAgent()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0135_viewIssueOfAgent";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Agent Issue opened";
				ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathPhaseShowMenu"),GlobalVariables.viewElements.get("issue"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Assertion: Verify that "Agent Issue" page loaded 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Agent Issue' gets loaded";
