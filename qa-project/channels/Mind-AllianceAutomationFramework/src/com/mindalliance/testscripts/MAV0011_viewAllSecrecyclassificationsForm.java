...
public class MAV0011_viewAllSecrecyclassificationsForm
{
	public MAV0011_viewAllSecrecyclassificationsForm()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0011_viewAllSecrecyclassificationsForm";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Clicks on 'Secrecy classifications' link under show pop up menu option on About plan window
				GlobalVariables.iStepNo++ ;
				...
				// Verify that "Secrecy classifications" page loaded 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription = "Verify that form with heading 'Secrecy classifications' gets loaded on the About Plan window";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0011_viewAllSecrecyclassificationsForm();
