...
public class MAV0209_AddInfoReceiveSendAttachOptions 
{
	public MAV0209_AddInfoReceiveSendAttachOptions(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0209_AddInfoReceiveSendAttachOptions";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Attach Option"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0209_AddInfoReceiveSendAttachOptions();
