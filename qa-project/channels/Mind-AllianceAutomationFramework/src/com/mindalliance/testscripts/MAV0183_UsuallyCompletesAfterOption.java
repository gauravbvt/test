...
public class MAV0183_UsuallyCompletesAfterOption 
{
	public MAV0183_UsuallyCompletesAfterOption(){
    	try {
    		GlobalVariables.sTestCaseId = "MAV0183_UsuallyCompletesAfterOption";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0183_UsuallyCompletesAfterOption();
