...
public class MAV0243_ShowRequirements 
{
	public MAV0243_ShowRequirements(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0243_ShowRequirements";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				//Clicks on Requirement link under show pop up menu option
				GlobalVariables.iStepNo++ ;
				...
				// Assertion: Verify that About Plan window loaded
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="'Requirement' Page get renders";
				...
				if (GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("informationSharingRequirements"))) {
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);	    	     
