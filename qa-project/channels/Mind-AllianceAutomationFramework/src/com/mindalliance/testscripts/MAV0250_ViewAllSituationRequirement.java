...
public class MAV0250_ViewAllSituationRequirement 
{
	public MAV0250_ViewAllSituationRequirement(){		
		try {
			GlobalVariables.sTestCaseId = "MAV0250_ViewAllSituationRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on drop down of Situation and select During,before or after
				GlobalVariables.iStepNo++ ;
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0250_ViewAllSituationRequirement();
