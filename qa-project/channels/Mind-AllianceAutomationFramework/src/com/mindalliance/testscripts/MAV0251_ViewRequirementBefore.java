...
public class MAV0251_ViewRequirementBefore 
{
	public MAV0251_ViewRequirementBefore(){		
		try {
			GlobalVariables.sTestCaseId = "MAV0251_ViewRequirementBefore";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0251_ViewRequirementBefore();
