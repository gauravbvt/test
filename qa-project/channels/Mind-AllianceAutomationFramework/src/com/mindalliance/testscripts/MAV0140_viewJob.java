...
public class MAV0140_viewJob
{
	public MAV0140_viewJob()
	{
		try{
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on jobs tab
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Jobs tab";
				if (GlobalVariables.sBrowser.equals("Internet Explorer")) {
				GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathOrganizationJob")));
				...
				Thread.currentThread();
				Thread.sleep(2000);
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathOrganizationJob"))).click();
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				if(GlobalVariables.oElement.getText().contains(GlobalVariables.viewElements.get("confirmed"))){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected "+GlobalVariables.viewElements.get("confirmed")+" Actual "+GlobalVariables.oElement.getText();
					// Write Results
