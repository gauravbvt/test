...
public class MAV0254_ViewRequirementAtAnyEvent 
{
	public MAV0254_ViewRequirementAtAnyEvent(){		
		try {
			GlobalVariables.sTestCaseId = "MAV0254_ViewRequirementAtAnyEvent";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on drop down of Event and select Any Event
				GlobalVariables.iStepNo++ ;
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0254_ViewRequirementAtAnyEvent();
