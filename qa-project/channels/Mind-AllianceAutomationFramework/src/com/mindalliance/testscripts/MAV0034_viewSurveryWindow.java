...
public class MAV0034_viewSurveryWindow {
	
public MAV0034_viewSurveryWindow(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0034_viewSurveryWindow";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Assertion: Verify that new window loaded with heading "Surveys" 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="Verify that window laoded with heading 'Surveys'";		            		         
