 ...
 * 	   Summary: Verify that user is able to redo the attached  document
 * @author AFour
 * 
 */
public class MAC0047_RedoAttachDocument {
	public MAC0047_RedoAttachDocument() {
		try {
			GlobalVariables.sTestCaseId = "MAC0047_RedoAttachDocument";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Redo Attach Document"));
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0047_RedoAttachDocument();
