...
public class MAV0160_viewSocialPanelHideCompleted 
{
	public MAV0160_viewSocialPanelHideCompleted()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0160_viewSocialPanelHideCompleted";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0160_viewSocialPanelHideCompleted();
