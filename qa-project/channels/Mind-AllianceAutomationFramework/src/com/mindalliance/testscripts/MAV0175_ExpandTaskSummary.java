...
public class MAV0175_ExpandTaskSummary 
{
	public MAV0175_ExpandTaskSummary(){
    	try {
    		GlobalVariables.sTestCaseId = "MAV0175_ExpandTaskSummary";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on default task to expand summary
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Expand Task summary";
