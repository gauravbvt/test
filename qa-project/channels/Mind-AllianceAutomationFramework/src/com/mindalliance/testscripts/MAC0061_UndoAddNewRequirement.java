...
public class MAC0061_UndoAddNewRequirement
{
	public MAC0061_UndoAddNewRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "MAC0061_UndoAddNewRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Undo Add New Requirement"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0061_UndoAddNewRequirement();
