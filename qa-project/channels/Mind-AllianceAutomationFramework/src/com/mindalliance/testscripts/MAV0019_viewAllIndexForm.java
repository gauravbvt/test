 ...
 *
 */
public class MAV0019_viewAllIndexForm
{
	public MAV0019_viewAllIndexForm()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0019_viewAllIndexForm";
			...
			// Clicks on 'index' link under show pop up menu option on About plan window 
			GlobalVariables.iStepNo++ ;
			...
			if (GlobalVariables.oElement.getText().equalsIgnoreCase(GlobalVariables.viewElements.get("details"))) {
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);    	    	     
