 ...
 *
 */
public class MAV0128_removeInfoNeed
{
	public MAV0128_removeInfoNeed()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0128_removeInfoNeed";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    // Clicks on "Remove info need" option under "more" pop up menu located on the "Receives" Pane
			    GlobalVariables.iStepNo++;
			    ...
			    // Assertion: Verify that dialog box is generated which displays a message "Are you sure ?"
			    GlobalVariables.iStepNo++;
