...
/**
 * TestCase ID: MAV0057_viewAllSegments
 * Summary: Verify that page loaded with heading "All events"
 * @author: AFour
 *
 */
public class MAV0057_viewAllSegments
{
	public MAV0057_viewAllSegments()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0057_viewAllSegments";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'All segments' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "All segments section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("allSegments"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'All segments' gets loaded on the About Plan Segment window";		            		         
