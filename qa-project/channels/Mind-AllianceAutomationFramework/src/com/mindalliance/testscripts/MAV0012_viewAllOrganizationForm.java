 ...
 *
 */
public class MAV0012_viewAllOrganizationForm
{
	public MAV0012_viewAllOrganizationForm() 
	{
	  try{
		  GlobalVariables.sTestCaseId = "MAV0012_viewAllOrganizationForm";
		  ...
		  if (GlobalVariables.bIsSuccess) {
			  ...
			  // Assertion: Verify that "All Organizations" page loaded 
			  GlobalVariables.iStepNo++;
			  GlobalVariables.sDescription="'All organization' Page get renders";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0012_viewAllOrganizationForm();
