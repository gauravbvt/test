...
public class MAV0026_viewAboutPlanSegmentWindow
{
	public MAV0026_viewAboutPlanSegmentWindow(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0026_viewAboutPlanSegmentWindow";
			...
			if (GlobalVariables.bIsSuccess) {
                ...
                // Assertions: Verify that About Plan segment section loaded
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'About plan segment section opened";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0026_viewAboutPlanSegmentWindow();
