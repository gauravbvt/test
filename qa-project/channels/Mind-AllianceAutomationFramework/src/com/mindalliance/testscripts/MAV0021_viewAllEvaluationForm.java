 ...
 *
 */
public class MAV0021_viewAllEvaluationForm
{
	public MAV0021_viewAllEvaluationForm()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0021_viewAllEvaluationForm";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				//clicks on 'Evaluation' link under show pop up menu option on About plan window 
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Evalution section opened";
				...
				//Assertion: verify that "Evaluation" page loaded 
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Evaluation' gets loaded on the About Plan window";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0021_viewAllEvaluationForm();
