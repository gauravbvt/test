 ...
 * 	   Summary: Verify that user is able to redo the attachment which was pasted
 * @author AFour
 * 
 */
public class MAC0050_RedoPasteAttachment {
	public MAC0050_RedoPasteAttachment() {
		try {
			GlobalVariables.sTestCaseId = "MAC0050_RedoPasteAttachment";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
				    ...
				    for(WebElement option : options) {
				    	if("The Other Segment".equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
					...
					options = GlobalVariables.oDropDown.getOptions();
				    for(WebElement option : options) {
				    	if(option.getText().equals("Segment For Redo Paste Attachment")){
				    			option.setSelected();
				    			break;
				    	}
				    }
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0050_RedoPasteAttachment();
