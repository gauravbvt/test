...
/**
 * TestCase Id: MAV0070_allIndex
 * Summary: Verify that "Index" page loaded
 * @author: AFour
 *
 */
public class MAV0070_allIndex
{
	public MAV0070_allIndex() {
		try {
			GlobalVariables.sTestCaseId = "MAV0070_allIndex";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Index' gets loaded";		            		         
