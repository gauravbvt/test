 ...
 * 
 */
public class MAC0040_RedoIntermediateTask {
	public MAC0040_RedoIntermediateTask() {
		try {
			GlobalVariables.sTestCaseId = "MAC0040_RedoIntermediateTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					// Click on 'Redo add intermediate' option under 'Actions' pop up menu
					GlobalVariables.iStepNo++ ;
...
//					alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0040_RedoIntermediateTask();
