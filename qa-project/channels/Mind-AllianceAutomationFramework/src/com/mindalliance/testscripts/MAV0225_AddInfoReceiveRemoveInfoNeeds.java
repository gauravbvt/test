...
public class MAV0225_AddInfoReceiveRemoveInfoNeeds 
{
	public MAV0225_AddInfoReceiveRemoveInfoNeeds(){
    	try {    		
    		GlobalVariables.sTestCaseId = "MAV0225_AddInfoReceiveRemoveInfoNeeds";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Remove Info Need"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0225_AddInfoReceiveRemoveInfoNeeds();
