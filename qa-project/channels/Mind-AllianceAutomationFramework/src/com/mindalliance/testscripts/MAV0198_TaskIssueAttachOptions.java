...
public class MAV0198_TaskIssueAttachOptions 
{
	public MAV0198_TaskIssueAttachOptions(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0198_TaskIssueAttachOptions";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0198_TaskIssueAttachOptions();
