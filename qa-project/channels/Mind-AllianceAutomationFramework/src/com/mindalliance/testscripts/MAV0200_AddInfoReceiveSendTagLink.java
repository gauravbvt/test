...
public class MAV0200_AddInfoReceiveSendTagLink
{
	public MAV0200_AddInfoReceiveSendTagLink(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0200_AddInfoReceiveSendTagLink";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Tags Link"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0200_AddInfoReceiveSendTagLink();
