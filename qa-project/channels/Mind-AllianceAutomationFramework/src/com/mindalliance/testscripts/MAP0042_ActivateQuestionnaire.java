...
public class MAP0042_ActivateQuestionnaire {
	public MAP0042_ActivateQuestionnaire() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0042_ActivateQuestionnaire";
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0042_ActivateQuestionnaire();
