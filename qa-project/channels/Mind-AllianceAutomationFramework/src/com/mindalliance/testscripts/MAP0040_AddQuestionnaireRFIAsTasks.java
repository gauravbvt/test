...
public class MAP0040_AddQuestionnaireRFIAsTasks {
	public MAP0040_AddQuestionnaireRFIAsTasks() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0040_AddQuestionnaireRFIAsTasks";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Tasks'";
			    ...
			    for(WebElement option : options) {
			    	if("tasks".equals(option.getText())){
			    			option.setSelected();
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Tasks' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
				...
				// Assertion: Verify that the RFI For 'Tasks' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Tasks'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Tasks")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0040_AddQuestionnaireRFIAsTasks();
