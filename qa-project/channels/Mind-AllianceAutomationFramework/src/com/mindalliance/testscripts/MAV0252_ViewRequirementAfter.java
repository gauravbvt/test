...
public class MAV0252_ViewRequirementAfter 
{
	public MAV0252_ViewRequirementAfter(){		
		try {
			GlobalVariables.sTestCaseId = "MAV0252_ViewRequirementAfter";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.FALSE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed Expected " + GlobalVariables.testData.get("After") + " Actual "+GlobalVariables.sStrCheck;
			    	// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0252_ViewRequirementAfter();
