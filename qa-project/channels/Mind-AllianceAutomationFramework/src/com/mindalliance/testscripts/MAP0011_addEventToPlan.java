 ...
 *
 */
public class MAP0011_addEventToPlan 
{
	public MAP0011_addEventToPlan() {
		try {
			GlobalVariables.sTestCaseId = "MAP0011_addEventToPlan";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Add Event To Plan"));
				...
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				System.out.println("Unable to Add Event to the Plan" + ReportFunctions.getScreenShot("Add Event to the Plan failed"));
