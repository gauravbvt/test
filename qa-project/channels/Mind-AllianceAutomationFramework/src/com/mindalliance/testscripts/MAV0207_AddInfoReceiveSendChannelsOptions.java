...
public class MAV0207_AddInfoReceiveSendChannelsOptions 
{
	public MAV0207_AddInfoReceiveSendChannelsOptions(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0207_AddInfoReceiveSendChannelsOptions";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Channels Option"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0207_AddInfoReceiveSendChannelsOptions();
