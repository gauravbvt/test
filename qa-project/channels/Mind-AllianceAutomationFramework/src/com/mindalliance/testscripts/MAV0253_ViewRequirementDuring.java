...
public class MAV0253_ViewRequirementDuring 
{
	public MAV0253_ViewRequirementDuring(){		
		try {
			GlobalVariables.sTestCaseId = "MAV0253_ViewRequirementDuring";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.FALSE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed Expected " + GlobalVariables.testData.get("During") + " Actual "+GlobalVariables.sStrCheck;
			    	// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0253_ViewRequirementDuring();
