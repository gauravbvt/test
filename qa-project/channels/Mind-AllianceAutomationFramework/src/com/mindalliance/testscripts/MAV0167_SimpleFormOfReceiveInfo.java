...
public class MAV0167_SimpleFormOfReceiveInfo 
{
	public MAV0167_SimpleFormOfReceiveInfo(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0167_SimpleFormOfReceiveInfo";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0167_SimpleFormOfReceiveInfo();
