...
public class MAV0206_AddInfoReceiveSendChannels 
{
	public MAV0206_AddInfoReceiveSendChannels(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0206_AddInfoReceiveSendChannels";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0206_AddInfoReceiveSendChannels();
