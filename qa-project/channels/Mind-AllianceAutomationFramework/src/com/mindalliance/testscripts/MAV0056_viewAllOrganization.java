...
/**
 * TestCase ID: MAV0056_viewAllOrganization
 * Summary: Verify that page loaded with heading "AllOrganization"
 * @author: AFour
 *
 */
public class MAV0056_viewAllOrganization
{
	public MAV0056_viewAllOrganization()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0056_viewAllOrganization";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'All organizations' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "All organizations section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("allOrganizations"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'All organizations' gets loaded on the About Plan Segment window";		            		         
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0056_viewAllOrganization();
