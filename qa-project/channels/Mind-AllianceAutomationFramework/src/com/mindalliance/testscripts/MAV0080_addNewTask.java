 ...
 *
 */
public class MAV0080_addNewTask 
{
	public MAV0080_addNewTask() {
		try {
			GlobalVariables.sTestCaseId = "MAV0080_addNewTask";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Actions' link under show pop up menu option 	
				GlobalVariables.iStepNo++ ;
			    ...
			    {
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected "+GlobalVariables.viewElements.get("task")+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
