...
public class MAP0007_addOrganizationsDetails
{
	public MAP0007_addOrganizationsDetails() {
		try {
			GlobalVariables.sTestCaseId = "MAP0007_addOrganizationsDetails";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Org selected";
				...
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Organization Details Added";
				GlobalVariables.oDriver.findElement(By.className("close")).click();
				// Assertion: Verify that the details are added to the organization.
				...
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				System.out.println("Unable to Add Organization Details" + ReportFunctions.getScreenShot("Add Organization Details failed"));
    ...
    public static void main(String args[]) {
		try {
			...
			new MAP0007_addOrganizationsDetails();
