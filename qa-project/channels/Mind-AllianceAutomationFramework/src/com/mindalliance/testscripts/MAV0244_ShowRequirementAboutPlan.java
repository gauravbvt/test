...
public class MAV0244_ShowRequirementAboutPlan 
{
	public MAV0244_ShowRequirementAboutPlan(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0244_ShowRequirementAboutPlan";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0244_ShowRequirementAboutPlan();
