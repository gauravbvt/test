...
public class MAP0038_AddQuestionnaireRFIAsRole {
	public MAP0038_AddQuestionnaireRFIAsRole() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0038_AddQuestionnaireRFIAsRole";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Role'";
			    ...
			    for(WebElement option : options) {
			    	if("roles".equals(option.getText())){
			    			option.setSelected();
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Places' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
				...
				// Assertion: Verify that the RFI For 'Role' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Role'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Roles")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Role' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0038_AddQuestionnaireRFIAsRole();
