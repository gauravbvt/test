...
public class MAP0031_AddQuestionnaireRFIAsAgent {
	public MAP0031_AddQuestionnaireRFIAsAgent() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0031_AddQuestionnaireRFIAsAgent";
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0031_AddQuestionnaireRFIAsAgent();
