 ...
 *
 */
public class MAV0066_viewAllSegmentsActionList 
{
	public MAV0066_viewAllSegmentsActionList()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0066_viewAllSegmentsActionList";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0066_viewAllSegmentsActionList();
