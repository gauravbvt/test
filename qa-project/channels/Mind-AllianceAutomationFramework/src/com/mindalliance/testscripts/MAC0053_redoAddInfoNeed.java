 ...
 * 	   Summary: Verify that user is able to redo the add (info) need
 * @author AFour
 * 
 */
public class MAC0053_redoAddInfoNeed {
	public MAC0053_redoAddInfoNeed() {
		try {
			GlobalVariables.sTestCaseId = "MAC0053_redoAddInfoNeed";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Redo Add Info Need"));
					...
					// Add info need flow in add info receive
					GlobalVariables.iStepNo++ ;
					...
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						...
						GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Add info received is displayed' "+" Actual 'Add info received is not displayed'";
				    	// Write Results
