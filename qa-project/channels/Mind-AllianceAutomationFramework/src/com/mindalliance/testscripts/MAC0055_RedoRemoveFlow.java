...
public class MAC0055_RedoRemoveFlow
{
	public MAC0055_RedoRemoveFlow() {
		try {
			GlobalVariables.sTestCaseId = "MAC0055_RedoRemoveFlow";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
				...
				for (int i = 0; i <= 50; i++)
					GlobalVariables.oElement.sendKeys(Keys.BACK_SPACE);
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Redo Remove Flow"));
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(8000);
				GlobalVariables.oElement.sendKeys(Keys.TAB);
