...
public class MAV0249_EditRequirement 
{
	public MAV0249_EditRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0249_EditRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on edit to edit the requirement
				GlobalVariables.iStepNo++;
				...
				// Remove Requirement
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Remove Requirement";
