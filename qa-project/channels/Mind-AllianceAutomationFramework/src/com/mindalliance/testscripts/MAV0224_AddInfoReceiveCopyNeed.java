...
public class MAV0224_AddInfoReceiveCopyNeed 
{
	public MAV0224_AddInfoReceiveCopyNeed(){
    	try {    		
    		GlobalVariables.sTestCaseId = "MAV0224_AddInfoReceiveCopyNeed";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Copy Need"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0224_AddInfoReceiveCopyNeed();
