...
public class MAP0036_AddQuestionnaireRFIAsPlaces {
	public MAP0036_AddQuestionnaireRFIAsPlaces() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0036_AddQuestionnaireRFIAsPlaces";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Places'";
			    ...
			    for(WebElement option : options) {
			    	if("places".equals(option.getText())){
			    			option.setSelected();
				...
				// Assertion: Verify that the RFI For 'Places' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Places'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Places")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0036_AddQuestionnaireRFIAsPlaces();
