...
/**
 * TestCase ID: MAV0059_viewAllissues
 * Summary: Verify that page loaded with heading "issues"
 * @author: AFour
 *
 */
public class MAV0059_viewAllissues 
{
	public MAV0059_viewAllissues()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0059_viewAllissues";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'All issues' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "All issues section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("allIssues"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Assertion: Verify that page loaded with heading "All issues" 
			    GlobalVariables.iStepNo++;
