...
/**
 * TestCase ID: viewSecrecyClassification
 * Summary: Verify that page loaded with heading "SecrecyClassification"
 * @author: AFour
 *
 */
public class MAV0055_viewSecrecyClassification 
{ 
	public MAV0055_viewSecrecyClassification()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0055_viewSecrecyClassification";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Secrecy classifications section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("secrecyClassification"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Secrecy classifications' gets loaded on the About Plan Segment window";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0055_viewSecrecyClassification();
