...
public class MAV0095_orgUnderAboutPlanSegment
{
	public MAV0095_orgUnderAboutPlanSegment()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0095_orgUnderAboutPlanSegment";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Organizations' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Organizations section opened";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0095_orgUnderAboutPlanSegment();
