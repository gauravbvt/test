...
public class MAV0106_goForward 
{
	public MAV0106_goForward(){
		
		try {
			GlobalVariables.sTestCaseId = "MAV0106_goForward";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    // Click on < Go Back img
			    GlobalVariables.iStepNo++ ;
			    GlobalVariables.sDescription = "< GoBack";
			    GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.assertion.get("sXpathGoBack"))).click();
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    // Click on > Go Forward img
			    GlobalVariables.iStepNo++ ;
			    GlobalVariables.sDescription = "> Go Forward";
			    ...
			    // Assertion: Verify that the window which is loaded next gets displayed
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="Verify that the window which is loaded next gets displayed";
