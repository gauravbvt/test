...
public class MAV0122_viewElementsOfInformation 
{
	public MAV0122_viewElementsOfInformation()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0122_viewElementsOfInformation";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathReceiveFlowMoreMenu") , "Show elements");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    // Assertion: Verify that window opens with heading "Elements of information"
			    GlobalVariables.iStepNo ++;
			    GlobalVariables.sDescription="Verify that window opens with heading 'Elements of information'";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0122_viewElementsOfInformation();
