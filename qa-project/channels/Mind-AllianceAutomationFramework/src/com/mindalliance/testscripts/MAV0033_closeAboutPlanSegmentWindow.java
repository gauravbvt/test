...
public class MAV0033_closeAboutPlanSegmentWindow {
	
	public MAV0033_closeAboutPlanSegmentWindow()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0033_closeAboutPlanSegmentWindow";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0033_closeAboutPlanSegmentWindow();
