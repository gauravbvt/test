...
/**
 * TestCase ID: MAV0054_viewAllEvents
 * Summary: Verify that page loaded with heading "AllEvents"
 * @author: AFour
 *
 */
public class MAV0054_viewAllEvents 
{
	public MAV0054_viewAllEvents()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0054_viewAllEvents";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("allEvents"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'All Events' gets loaded on the About Plan Segment window";
