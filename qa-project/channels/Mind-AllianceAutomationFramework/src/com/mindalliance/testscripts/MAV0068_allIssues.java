...
/**
 * TestCase Id: MAV0068_allIssues
 * Summary: Verify that "All issues" page loaded 
 * @author: AFour
 *
 */
public class MAV0068_allIssues 
{
	public MAV0068_allIssues() {
		try {
			GlobalVariables.sTestCaseId = "MAV0068_allIssues";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'All issues' gets loaded";		            		         
