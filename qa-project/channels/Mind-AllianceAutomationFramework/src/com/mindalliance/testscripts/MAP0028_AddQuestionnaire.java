...
public class MAP0028_AddQuestionnaire {
	public MAP0028_AddQuestionnaire() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0028_AddQuestionnaire";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(2000);
				// Assertion: Verify that Questionnaire gets added
