...
/**
 * Testcase ID: MAC0017_UndoAttachDocument
 * 	   Summary: Verify that user is able to undo the attached  document
 * @author AFour
 * 
 */
public class MAC0017_UndoAttachDocument {
	public MAC0017_UndoAttachDocument() {
		try {
			GlobalVariables.sTestCaseId = "MAC0017_UndoAttachDocument";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Undo Attach Document"));
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					System.out.println("Unable to Undo Attach Document"+ReportFunctions.getScreenShot("Undo Attach Document failed"));
	...
	public static void main(String args[]) {
		try {
			...
			new MAC0017_UndoAttachDocument();
