...
public class MAV0187_OngoingOrStartsWith 
{
	public MAV0187_OngoingOrStartsWith(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0187_OngoingOrStartsWith";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().contains(GlobalVariables.viewElements.get("taskStart"))) {
					...
					GlobalVariables.sVerifyError="Verifyication Failed Actual "+GlobalVariables.viewElements.get("taskStart") + " Expected "+ GlobalVariables.oElement.getText();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
				...
				if(GlobalVariables.oElement.getText().equals(".")) {
					...
					GlobalVariables.sVerifyError="Verifyication Failed Actual '.' Expected "+ GlobalVariables.oElement.getText();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0187_OngoingOrStartsWith();
