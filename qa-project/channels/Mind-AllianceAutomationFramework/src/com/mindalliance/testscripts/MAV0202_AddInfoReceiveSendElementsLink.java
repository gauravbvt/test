...
public class MAV0202_AddInfoReceiveSendElementsLink 
{
	public MAV0202_AddInfoReceiveSendElementsLink(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0202_AddInfoReceiveSendElementsLink";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Element Link"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0202_AddInfoReceiveSendElementsLink();
