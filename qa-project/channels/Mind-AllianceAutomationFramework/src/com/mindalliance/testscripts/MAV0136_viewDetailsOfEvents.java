...
public class MAV0136_viewDetailsOfEvents
{
	public MAV0136_viewDetailsOfEvents()
	{
		try{
			
			GlobalVariables.sTestCaseId = "MAV0136_viewDetailsOfEvents";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Event details";
			    ...
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Event details' gets loaded";
			    ...
			    if (GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("details"))) {
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected "+GlobalVariables.viewElements.get("etails")+" Actual "+GlobalVariables.oElement.getText();
					// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0136_viewDetailsOfEvents();
