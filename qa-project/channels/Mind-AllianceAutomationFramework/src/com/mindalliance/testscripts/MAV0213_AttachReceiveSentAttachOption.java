...
public class MAV0213_AttachReceiveSentAttachOption 
{
	public MAV0213_AttachReceiveSentAttachOption(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "MAV0213_AttachReceiveSentAttachOption";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Issue Attach Option"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0213_AttachReceiveSentAttachOption();
