...
/**
 * TestCase Id: MAV0024_viewAboutPlanActionList
 * Summary: Verify that Action gets Hovered
 * @author: AFour
 *
 */
public class MAV0024_viewAboutPlanActionList 
{
	public MAV0024_viewAboutPlanActionList()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0024_viewAboutPlanActionList";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Actions' link under show pop up menu option of "About plan" 	
				GlobalVariables.iStepNo++ ;
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0024_viewAboutPlanActionList();
