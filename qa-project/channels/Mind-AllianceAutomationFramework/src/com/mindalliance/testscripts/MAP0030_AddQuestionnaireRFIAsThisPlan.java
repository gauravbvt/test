...
public class MAP0030_AddQuestionnaireRFIAsThisPlan {
	public MAP0030_AddQuestionnaireRFIAsThisPlan() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0030_AddQuestionnaireRFIAsThisPlan";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("This plan")){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'This plan' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0030_AddQuestionnaireRFIAsThisPlan();
