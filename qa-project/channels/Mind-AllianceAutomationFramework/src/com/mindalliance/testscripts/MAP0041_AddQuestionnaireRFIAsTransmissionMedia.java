...
public class MAP0041_AddQuestionnaireRFIAsTransmissionMedia {
	public MAP0041_AddQuestionnaireRFIAsTransmissionMedia() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0041_AddQuestionnaireRFIAsTransmissionMedia";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Transmission Media'";
			    ...
			    for(WebElement option : options) {
			    	if("transmission media".equals(option.getText())){
			    			option.setSelected();
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Transmission Media' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
				...
				// Assertion: Verify that the RFI For 'Transmission Media' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Transmission Media'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Transmission Media")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0041_AddQuestionnaireRFIAsTransmissionMedia();
