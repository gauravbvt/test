...
/**
 * TestCase ID: MAV0060_viewBibliography
 * Summary: Verify that page loaded with heading "Bibliography"
 * @author: AFour
 *
 */
public class MAV0060_viewBibliography
{
	public MAV0060_viewBibliography()
	{
		try{
			GlobalVariables.sTestCaseId = "MAV0060_viewBibliography";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    //Clicks on 'Bibliography' link under show pop up menu option of "All segments" 	
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Bibliography section opened";
			    ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathAllSegmentShowMenu"),GlobalVariables.viewElements.get("bibliography"));
			    // Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Assertion: Verify that page loaded with heading "Bibliography"
			    GlobalVariables.iStepNo++;
			    GlobalVariables.sDescription="'Bibliography' gets loaded on the About Plan Segment window";		            		         
