...
public class MAP0037_AddQuestionnaireRFIAsPlanSegment {
	public MAP0037_AddQuestionnaireRFIAsPlanSegment() {
		try{		
			
			GlobalVariables.sTestCaseId = "MAP0037_AddQuestionnaireRFIAsPlanSegment";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Plan Segments'";
			    ...
			    for(WebElement option : options) {
			    	if("plan segments".equals(option.getText())){
			    			option.setSelected();
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Plan Segment' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
				...
				// Assertion: Verify that the RFI For 'Plan segment' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Plan segments'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Plan segments")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Plan Segments' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new MAP0037_AddQuestionnaireRFIAsPlanSegment();
