...
public class MAV0141_viewChart 
{
	public MAV0141_viewChart()
	{
		try{
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on Chart tab
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Chart tab";
				if (GlobalVariables.sBrowser.equals("Internet Explorer")) {
				GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathOrganizationChart")));
				...
				Thread.currentThread();
				Thread.sleep(1000);
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathOrganizationChart"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(1000);
				// Write Results
