	...
	public MAV0134_viewNetworkOfAgent()
	{
		try{
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    if (GlobalVariables.oElement.getText().equalsIgnoreCase(GlobalVariables.viewElements.get("network"))) {
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'network' Actual "+GlobalVariables.oElement.getText();
					// Write Results
