 ...
 * Summary: Verify that user is able to sent task information/event message to other user or agent
 * @author AfourTech
 *
 */
public class MAP0026_sendTask
{
	public MAP0026_sendTask() {
		try {
			GlobalVariables.sTestCaseId = "MAP0026_sendTask";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment for Send info"));
			    ...
			    for(WebElement option : options) {
			    	if(GlobalVariables.testData.get("Segment for Send info").equals(option.getText())){
			    			option.setSelected();
			    			break;
			    	}
			    }
				...
				//  Click on 'add info send' option under 'Send'  section
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Sends Informations";
				...
				GlobalVariables.oElement.sendKeys("Sends information");
				...
				Thread.currentThread();
				Thread.sleep(10000);
				// ASSERTION:  Verify that user is able to sent task information/event message to other user or agent
				...
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				System.out.println("Unable to Sends Task" + ReportFunctions.getScreenShot("Sends Task failed"));
