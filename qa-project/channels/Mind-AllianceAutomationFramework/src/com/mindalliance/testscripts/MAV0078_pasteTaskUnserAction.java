...
public class MAV0078_pasteTaskUnserAction
{
	public MAV0078_pasteTaskUnserAction() {
		try {
			GlobalVariables.sTestCaseId = "MAV0078_pasteTaskUnserAction";
	...
	public static void main(String args[]) {
		try {
			...
			new MAV0078_pasteTaskUnserAction();
