 ...
 * 
 */
public class MAC0039_RedoDuplicateTask {
	public MAC0039_RedoDuplicateTask() {
		try {
			GlobalVariables.sTestCaseId = "MAC0039_RedoDuplicateTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Redo Duplicate Task"), "New");
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					// Click 'Redo duplicate task' option under 'Actions' pop up menu of Task section
					GlobalVariables.iStepNo++ ;
