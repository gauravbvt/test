...
public class TE100_AttachFileToEvent 
{
	public TE100_AttachFileToEvent(){
		try {
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if (GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("This is File 1"))){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected '"+GlobalVariables.testData.get("This is File 1")+"' Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
