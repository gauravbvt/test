...
public class HP007_InformationSharingModelLink 
{
	public HP007_InformationSharingModelLink(){
    	try {
			GlobalVariables.sTestCaseId = "HP007_InformationSharingModelLink";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// 'Information Sharing Model' link
				...
				if(GlobalVariables.oElement.getText().equals("Information sharing model")){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Information sharing model' "+" Actual "+GlobalVariables.oElement.getText();
					// Write Results
    ...
    public static void main(String args[]) {
		try {
			...
			new HP007_InformationSharingModelLink();
