...
public class TE015_DeletePictureOfAgent 
{
	public TE015_DeletePictureOfAgent() {
		try {
			GlobalVariables.sTestCaseId = "TE015_DeletePictureOfAgent";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Delete Picture Of Agent"));
				    ...
				    for(WebElement option : options) {
				    	if(GlobalVariables.testData.get("Segment For Delete Picture Of Agent").equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
					...
					// Click on done
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Picture is Deleted";
					GlobalVariables.oDriver.findElement(By.className("close")).click();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
	...
	public static void main(String args[]) {
		try {
			...
			new TE015_DeletePictureOfAgent();
