...
public class PS115_ViewRequirementDuring 
{
	public PS115_ViewRequirementDuring(){		
		try {
			GlobalVariables.sTestCaseId = "PS115_ViewRequirementDuring";
			...
			if (GlobalVariables.bIsSuccess) {
			    ...
			    for(WebElement option : options) {
			    	if(GlobalVariables.testData.get("During").equals(option.getValue())){
	...
	public static void main(String args[]) {
		try {
			...
			new PS115_ViewRequirementDuring();
