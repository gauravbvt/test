...
public class TE039_UpdateLocaleCategoryWithJunkCharacters 
{
	public TE039_UpdateLocaleCategoryWithJunkCharacters() {
		try{
			
			GlobalVariables.sTestCaseId = "TE039_UpdateLocaleCategoryWithJunkCharacters";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get(")(*&^%$#!"))) {
					...
					GlobalVariables.sVerifyError="Verification Failed. Expected '"+GlobalVariables.testData.get(")(*&^%$#!")+"' Actual '"+GlobalVariables.oElement.getValue()+"'";
	    			// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
	...
	public static void main(String args[]) {
		try {
			...
			new TE039_UpdateLocaleCategoryWithJunkCharacters();
