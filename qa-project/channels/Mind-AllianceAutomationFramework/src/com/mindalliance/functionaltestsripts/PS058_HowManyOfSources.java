...
public class PS058_HowManyOfSources 
{
	public PS058_HowManyOfSources(){
		
		try {
			GlobalVariables.sTestCaseId = "PS058_HowManyOfSources";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathHowManyOfSourcesOfRequirement"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(1000);
				// Assertion: Verify that Info tab is present
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathHowManyOfSourcesOfRequirement")));
