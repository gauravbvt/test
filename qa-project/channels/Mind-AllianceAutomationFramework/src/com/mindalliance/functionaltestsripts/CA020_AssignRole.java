		...
		try {
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(cnt==1)
				{
					...
					GlobalVariables.oDriver.findElement(By.xpath("//body/div/div[2]/div/form/table[7]/tbody/tr/td[5]/input")).click();
				}
				else
				{
					GlobalVariables.oDriver.findElement(By.name("item:"+(cnt-1)+":group:password")).clear();
					...
					Thread.sleep(2000);
					// Assign Access Privilege
					GlobalVariables.oDriver.findElement(By.xpath("//body/div/div[2]/div/form/table[7]/tbody/tr["+cnt+"]/td[5]/input")).click();
				}
				// Click on 'Submit' Button
				GlobalVariables.oDriver.findElement(By.name("Submit")).submit();
				// WebElement Synchronization
