...
public class SQ0010_AddQuestionnaireRFIAsPlanSegment {
	public SQ0010_AddQuestionnaireRFIAsPlanSegment() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0010_AddQuestionnaireRFIAsPlanSegment";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0010_AddQuestionnaireRFIAsPlanSegment();
