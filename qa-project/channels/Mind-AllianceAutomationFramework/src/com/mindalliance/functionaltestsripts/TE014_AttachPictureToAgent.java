		...
		try {
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Attach Picture Of Agent"));
				    ...
				    for(WebElement option : options) {
				    	if(GlobalVariables.testData.get("Segment For Attach Picture Of Agent").equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
