	...
	public TFP055_AddInfoReceiveSendTagDetails(){
    	try {
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Tags Details"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info sent")).click();
				...
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Tag Details Entered of Send info";
				GlobalVariables.oDriver.findElement(By.name("segment:sends:flows-div:flows:0:flow:tagsContainer:tags:tags")).click();
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("segment:sends:flows-div:flows:0:flow:tagsContainer:tags:tags"));
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
				...
				// Enter Tag Details of 'Add Info Receive' 
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Tag Details Entered of Receive info";				
				GlobalVariables.oDriver.findElement(By.name("segment:receives:flows-div:flows:0:flow:tagsContainer:tags:tags")).click();
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("segment:receives:flows-div:flows:0:flow:tagsContainer:tags:tags"));
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("This is a Tag"));
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(2000);		
