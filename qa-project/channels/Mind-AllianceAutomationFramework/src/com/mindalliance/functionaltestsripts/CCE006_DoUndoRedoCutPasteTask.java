...
public class CCE006_DoUndoRedoCutPasteTask 
{
	public CCE006_DoUndoRedoCutPasteTask() {
		try {
			GlobalVariables.sTestCaseId = "CCE006_DoUndoRedoCutPasteTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Do Undo Redo Cut Paste Task"), "New");
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
				    ...
				    for(WebElement option : options) {
				    	if(GlobalVariables.testData.get("Segment For Do Undo Redo Cut Paste Task").equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
	...
	public static void main(String args[]) {
		try {
			...
			new CCE006_DoUndoRedoCutPasteTask();
