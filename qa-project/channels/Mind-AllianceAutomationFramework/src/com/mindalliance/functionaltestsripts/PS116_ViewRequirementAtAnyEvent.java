...
public class PS116_ViewRequirementAtAnyEvent 
{
	public PS116_ViewRequirementAtAnyEvent(){		
		try {
			GlobalVariables.sTestCaseId = "PS116_ViewRequirementAtAnyEvent";
...
//				GlobalVariables.oElement=GlobalVariables.
	...
	public static void main(String args[]) {
		try {
			...
			new PS116_ViewRequirementAtAnyEvent();
