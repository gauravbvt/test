...
public class CCE030_DoUndoRedoRemoveRequirement 
{
	public CCE030_DoUndoRedoRemoveRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "CCE030_DoUndoRedoRemoveRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Undo Redo Remove Requirement"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new CCE030_DoUndoRedoRemoveRequirement();
