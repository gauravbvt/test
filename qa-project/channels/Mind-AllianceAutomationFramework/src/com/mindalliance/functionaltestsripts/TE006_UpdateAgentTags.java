...
public class TE006_UpdateAgentTags 
{
	public TE006_UpdateAgentTags() {
		try{
			
			GlobalVariables.sTestCaseId = "TE006_UpdateAgentTags";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(2000);
				//Assertion : Verify that tags gets updated
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathAgentContacts"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(2000);
		    	...
		    	{
		    		GlobalVariables.sVerifyError="Verification Failed. Expected '"+GlobalVariables.viewElements.get("tagDescription")+"' Actual '"+GlobalVariables.oElement.getText()+"'";
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
