...
public class PS037_RequirmentTags 
{
	public PS037_RequirmentTags(){
		
		try {
			GlobalVariables.sTestCaseId = "PS037_RequirmentTags";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Enter Tags in Requirement description text filed
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Requirement Tags entred";
				GlobalVariables.oDriver.findElement(By.name("plan:content:mo:aspect:tabs:panel:requirement:tags:tags")).clear();
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("plan:content:mo:aspect:tabs:panel:requirement:tags:tags"));
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Requirement Tags"));
