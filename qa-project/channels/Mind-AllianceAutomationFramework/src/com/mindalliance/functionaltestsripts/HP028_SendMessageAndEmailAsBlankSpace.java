...
public class HP028_SendMessageAndEmailAsBlankSpace 
{
	public HP028_SendMessageAndEmailAsBlankSpace() {
		try {
			GlobalVariables.sTestCaseId = "HP028_SendMessageAndEmailAsBlankSpace";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Send Message as blank space";
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathSendMessageAndEmailSocialPanel"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(5000);
	...
	public static void main(String args[]) {
		try {
			...
			new HP028_SendMessageAndEmailAsBlankSpace();
