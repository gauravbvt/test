...
public class TFP104_AdvanceFormOfSentInfo 
{
	public TFP104_AdvanceFormOfSentInfo(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP104_AdvanceFormOfSentInfo";
...
//				// Get a handle to the open alert, prompt or confirmation
	...
	public static void main(String args[]) {
		try {
			...
			new TFP104_AdvanceFormOfSentInfo();
