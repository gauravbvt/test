...
public class TE132_CreateOrganizationWithSpecialCharacters 
{
	public TE132_CreateOrganizationWithSpecialCharacters() {
		try {
			GlobalVariables.sTestCaseId = "TE132_CreateOrganizationWithSpecialCharacters";
	...
	public static void main(String args[]) {
		try {
			...
			new TE132_CreateOrganizationWithSpecialCharacters();
