...
public class TFP035_TaskAttachmentAsPolicyMust 
{
	public TFP035_TaskAttachmentAsPolicyMust(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP035_TaskAttachmentAsPolicyMust";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Task Attachment as Mandating Policy"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new TFP035_TaskAttachmentAsPolicyMust();
