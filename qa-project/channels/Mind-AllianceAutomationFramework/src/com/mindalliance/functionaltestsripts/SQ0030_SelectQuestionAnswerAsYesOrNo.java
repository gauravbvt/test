...
public class SQ0030_SelectQuestionAnswerAsYesOrNo {
	public SQ0030_SelectQuestionAnswerAsYesOrNo() {
		try{		
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select Answer as yes or no
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select Question answer as 'yes or no' ";
			    ...
			    for(WebElement option : options) {
			    	if("yes or no".equals(option.getText())){
			    			option.setSelected();
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0030_SelectQuestionAnswerAsYesOrNo();
