...
public class CA025_PlanNameWithSameURI
{
	public CA025_PlanNameWithSameURI() {
		try {
			GlobalVariables.sTestCaseId = "CA025_PlanNameWithSameURI";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// // Enter the details: newPlanUri
				GlobalVariables.iStepNo++ ;
				GlobalVariables.sDescription = "Again enter (New Plan URI) and (owned by)";
				GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.name("newPlanUri"));
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Add Test Plan"));
				// newPlanClient
				GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.name("newPlanClient"));
				...
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("/html/body/div/div[2]/div/form/div[2]/ul/li/span"));
				// Assertion: Verify Select the plan
		    	if(GlobalVariables.oElement.getText().equals("A plan with that uri already exists")){
		    		// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
