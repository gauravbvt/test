...
public class CP023_ShowSentMessages
{
	public CP023_ShowSentMessages(){
		try {
			GlobalVariables.sTestCaseId = "CP023_ShowSentMessages";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if (GlobalVariables.oElement.getText().equals("show received")) {
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'show received' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
