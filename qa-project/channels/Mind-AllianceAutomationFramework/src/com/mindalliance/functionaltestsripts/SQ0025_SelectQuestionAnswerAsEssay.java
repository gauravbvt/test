...
public class SQ0025_SelectQuestionAnswerAsEssay {
	public SQ0025_SelectQuestionAnswerAsEssay() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0025_SelectQuestionAnswerAsEssay";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select Answer as essay
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select Question answer as 'essay' ";
			    ...
			    for(WebElement option : options) {
			    	if("essay".equals(option.getText())){
			    			option.setSelected();
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0025_SelectQuestionAnswerAsEssay();
