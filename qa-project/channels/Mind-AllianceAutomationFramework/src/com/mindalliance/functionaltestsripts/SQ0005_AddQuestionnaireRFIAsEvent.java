...
public class SQ0005_AddQuestionnaireRFIAsEvent {
	public SQ0005_AddQuestionnaireRFIAsEvent() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0005_AddQuestionnaireRFIAsEvent";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0004_AddQuestionnaireRFIAsAgent();
