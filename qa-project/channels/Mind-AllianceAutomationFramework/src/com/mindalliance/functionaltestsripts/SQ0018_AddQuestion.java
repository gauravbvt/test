...
public class SQ0018_AddQuestion {
	public SQ0018_AddQuestion() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0018_AddQuestion";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("(Inactive) --TBD--")){
					...
					GlobalVariables.sVerifyError="Verification failed Expected '(Inactive) --TBD--' Actual "+GlobalVariables.oElement.getText();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
