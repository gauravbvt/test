...
public class SQ0031_SelectQuestionAnswerAsShortText {
	public SQ0031_SelectQuestionAnswerAsShortText() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0031_SelectQuestionAnswerAsShortText";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select Answer as short text
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select Question answer as 'short text' ";
			    ...
			    for(WebElement option : options) {
			    	if("short text".equals(option.getText())){
			    			option.setSelected();
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0031_SelectQuestionAnswerAsShortText();
