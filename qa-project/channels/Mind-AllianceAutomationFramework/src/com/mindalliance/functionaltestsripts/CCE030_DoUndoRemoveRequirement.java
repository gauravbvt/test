...
public class CCE030_DoUndoRemoveRequirement 
{
	public CCE030_DoUndoRemoveRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "CCE030_DoUndoRemoveRequirement";
	...
	public static void main(String args[]) {
		try {
			...
			new CCE030_DoUndoRemoveRequirement();
