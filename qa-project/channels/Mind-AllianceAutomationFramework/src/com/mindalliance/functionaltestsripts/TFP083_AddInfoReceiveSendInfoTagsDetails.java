...
public class TFP083_AddInfoReceiveSendInfoTagsDetails 
{
	public TFP083_AddInfoReceiveSendInfoTagsDetails(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP083_AddInfoReceiveSendInfoTagsDetails";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Issue Tags Details"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
