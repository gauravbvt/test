...
public class SQ0023_SelectQuestionAnswerAsStatement {
	public SQ0023_SelectQuestionAnswerAsStatement() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0023_SelectQuestionAnswerAsStatement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select Answer as Statement
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select Question answer as 'statement' ";
			    ...
			    for(WebElement option : options) {
			    	if("statement".equals(option.getText())){
			    			option.setSelected();
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0023_SelectQuestionAnswerAsStatement();
