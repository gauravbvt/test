...
public class PS071_WhenOfReceivers 
{
	public PS071_WhenOfReceivers(){
		
		try {
			GlobalVariables.sTestCaseId = "PS071_WhenOfReceivers";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on When Tab of Receivers
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="When Tab of Requirement";
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathWhenTabOfReceiversOfRequirement"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(1000);				
				// Assertion: Verify that Info tab is present
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathWhenTabOfReceiversOfRequirement")));
