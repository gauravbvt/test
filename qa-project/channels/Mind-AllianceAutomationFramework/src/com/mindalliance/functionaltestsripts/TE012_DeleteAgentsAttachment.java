...
public class TE012_DeleteAgentsAttachment 
{
	public TE012_DeleteAgentsAttachment() {
		try {
			GlobalVariables.sTestCaseId = "TE012_DeleteAgentsAttachment";
	...
	public static void main(String args[]) {
		try {
			...
			new TE012_DeleteAgentsAttachment();
