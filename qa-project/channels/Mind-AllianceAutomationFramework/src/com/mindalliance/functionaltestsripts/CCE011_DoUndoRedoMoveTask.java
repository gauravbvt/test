...
public class CCE011_DoUndoRedoMoveTask 
{
	public CCE011_DoUndoRedoMoveTask() {
		try {
			GlobalVariables.sTestCaseId = "CCE011_DoUndoRedoMoveTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.name("sg-editor:content:mo:aspect:name"));
						for (int i = 0; i <= 8; i++)
							GlobalVariables.oElement.sendKeys(Keys.BACK_SPACE);
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Do Undo Redo Move Task"));
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					// Undo- Click on 'Undo move task' option under 'Actions' pop up menu
					GlobalVariables.iStepNo++ ;
					...
					options = GlobalVariables.oDropDown.getOptions();
				    for(WebElement option : options) {
				    	if(GlobalVariables.testData.get("Segment For Do Undo Redo Move Task").equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
					...
					// Click on 'Redo move task' option under Action pop up menu
					GlobalVariables.iStepNo++ ;
					GlobalVariables.sDescription = "Redo move tasks done";
					ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathActionsPopUpMenu"),GlobalVariables.viewElements.get("redoMoveTasks"));
					// ASSERTION 2.2: When clicked on 'Undo move task' option under 'Actions' pop up menu
					if ((GlobalVariables.bIsSuccess == Boolean.FALSE)) {
						GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.className("data-table"));
						tds = GlobalVariables.oElement.findElements(By.tagName("td"));
