...
public class TFP086_AttachReceiveSentAttachOption 
{
	public TFP086_AttachReceiveSentAttachOption(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP086_AttachReceiveSentAttachOption";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP086_AttachReceiveSentAttachOption();
