...
public class SQ0011_AddQuestionnaireRFIAsRole {
	public SQ0011_AddQuestionnaireRFIAsRole() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0011_AddQuestionnaireRFIAsRole";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Roles")){
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Roles' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
							GlobalVariables.sBlank, GlobalVariables.sVerifyError);
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0011_AddQuestionnaireRFIAsRole();
