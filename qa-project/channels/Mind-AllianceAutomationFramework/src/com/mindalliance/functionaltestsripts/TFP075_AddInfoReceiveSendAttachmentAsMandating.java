...
public class TFP075_AddInfoReceiveSendAttachmentAsMandating 
{
	public TFP075_AddInfoReceiveSendAttachmentAsMandating(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP075_AddInfoReceiveSendAttachmentAsMandating";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP075_AddInfoReceiveSendAttachmentAsMandating();
