...
public class TFP085_AddInfoReceiveSentSuggestion 
{
	public TFP085_AddInfoReceiveSentSuggestion(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP085_AddInfoReceiveSentSuggestion";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Issue Suggestions"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new TFP085_AddInfoReceiveSentSuggestion();
