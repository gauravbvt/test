...
public class TFP049_IssueAttachmentAsURL 
{
	public TFP049_IssueAttachmentAsURL(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP049_IssueAttachmentAsURL";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Issue Attachment As URL"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathTaskIssueURL"))).click();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(2000);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP049_IssueAttachmentAsURL();
