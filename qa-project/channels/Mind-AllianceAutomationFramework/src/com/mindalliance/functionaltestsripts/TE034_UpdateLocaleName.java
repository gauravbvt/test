...
public class TE034_UpdateLocaleName 
{
	public TE034_UpdateLocaleName() {
		try{
			
			GlobalVariables.sTestCaseId = "TE034_UpdateLocaleName";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Places Updated"));
				GlobalVariables.oElement.sendKeys(Keys.TAB);
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(2000);
				...
				if(GlobalVariables.oElement.getValue().equals(GlobalVariables.testData.get("Places Updated"))) {
					...
					GlobalVariables.sVerifyError="Verification Failed. Expected '"+GlobalVariables.testData.get("Places Updated")+"' Actual '"+GlobalVariables.oElement.getValue()+"'";
	    			// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
