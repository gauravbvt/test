...
public class SQ0020_ActivateQuestion {
	public SQ0020_ActivateQuestion() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0020_ActivateQuestion";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(2000);	
				// Assertion: Verify that Named Question gets added
