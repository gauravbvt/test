...
public class HP027_SendMessageAsBlankSpace 
{
	public HP027_SendMessageAsBlankSpace() {
		try {
			GlobalVariables.sTestCaseId = "HP027_SendMessageAsBlankSpace";
	...
	public static void main(String args[]) {
		try {
			...
			new HP027_SendMessageAsBlankSpace();
