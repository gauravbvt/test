...
public class PS030_AboutPlanRequirement 
{
	public PS030_AboutPlanRequirement(){		
		try {
			GlobalVariables.sTestCaseId = "PS030_AboutPlanRequirement";
	...
	public static void main(String args[]) {
		try {
			...
			new PS030_AboutPlanRequirement();
