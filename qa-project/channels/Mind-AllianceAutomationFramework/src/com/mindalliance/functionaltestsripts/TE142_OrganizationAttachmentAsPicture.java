...
public class TE142_OrganizationAttachmentAsPicture 
{
	public TE142_OrganizationAttachmentAsPicture() {
		try {
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Organization Attachment as Picture";
