...
public class HP029_SendBlankMessageAndEmail 
{
	public HP029_SendBlankMessageAndEmail() {
		try {
			GlobalVariables.sTestCaseId = "HP029_SendBlankMessageAndEmail";
	...
	public static void main(String args[]) {
		try {
			...
			new HP029_SendBlankMessageAndEmail();
