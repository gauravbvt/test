...
public class TFP076_AddInfoReceiveSendAttachmentAsProhibited 
{
	public TFP076_AddInfoReceiveSendAttachmentAsProhibited(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP076_AddInfoReceiveSendAttachmentAsProhibited";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP076_AddInfoReceiveSendAttachmentAsProhibited();
