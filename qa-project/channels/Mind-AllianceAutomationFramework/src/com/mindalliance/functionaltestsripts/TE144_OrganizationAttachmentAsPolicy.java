...
public class TE144_OrganizationAttachmentAsPolicy 
{
	public TE144_OrganizationAttachmentAsPolicy() {
		try {
			GlobalVariables.sTestCaseId = "TE144_OrganizationAttachmentAsPolicy";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Organization Attachment as Policy";
