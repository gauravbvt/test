...
public class TFP077_AddInfoReceiveSendAttachmentAsPicture 
{
	public TFP077_AddInfoReceiveSendAttachmentAsPicture(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP077_AddInfoReceiveSendAttachmentAsPicture";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Receive Send Attachment As Picture"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Sends : Attach File as Picture
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="File Attached as Picture";
				...
				// Receives : Attach File as Picture
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="File Attached as Picture";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP077_AddInfoReceiveSendAttachmentAsPicture();
