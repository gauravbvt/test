...
public class TE139_OrganizationCategories
{
	public TE139_OrganizationCategories() {
		try {
			GlobalVariables.sTestCaseId = "TE139_OrganizationCategories";
...
//					alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TE139_OrganizationCategories();
