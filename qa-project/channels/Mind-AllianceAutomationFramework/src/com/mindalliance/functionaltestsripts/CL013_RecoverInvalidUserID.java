...
public class CL013_RecoverInvalidUserID {
	public CL013_RecoverInvalidUserID(){
		try {
			
			GlobalVariables.sTestCaseId = "CL013_RecoverInvalidUserID";
			...
			GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.className("username"));
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Unrecognized user name error message displayed";
			GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath("/html/body/div/div[2]/div/span"));
			if(GlobalVariables.oElement.getText().equals("Unrecognized user name.")){
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Unrecognized user name.' Actual '"+GlobalVariables.oElement.getText()+"'";
				// Write Results
