...
public class PS035_RequirementName 
{
	public PS035_RequirementName(){
		
		try {
			GlobalVariables.sTestCaseId = "PS035_RequirementName";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("Requirement"))){
					...
					GlobalVariables.sVerifyError="Verification Failed Expected '"+GlobalVariables.testData.get("Requirement")+"' Actual "+GlobalVariables.oElement.getText();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
