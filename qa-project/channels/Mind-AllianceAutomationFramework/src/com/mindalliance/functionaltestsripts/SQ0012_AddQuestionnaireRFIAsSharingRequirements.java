...
public class SQ0012_AddQuestionnaireRFIAsSharingRequirements {
	public SQ0012_AddQuestionnaireRFIAsSharingRequirements() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0012_AddQuestionnaireRFIAsSharingRequirements";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0012_AddQuestionnaireRFIAsSharingRequirements();
