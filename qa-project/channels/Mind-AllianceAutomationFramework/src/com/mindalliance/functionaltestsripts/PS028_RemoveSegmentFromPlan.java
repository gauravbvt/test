...
public class PS028_RemoveSegmentFromPlan 
{
	public PS028_RemoveSegmentFromPlan() {
		try {
			GlobalVariables.sTestCaseId = "PS028_RemoveSegmentFromPlan";
	...
	public static void main(String args[]) {
		try {
			...
			new PS028_RemoveSegmentFromPlan();
