...
public class SQ0008_AddQuestionnaireRFIAsPhaseOfEvents {
	public SQ0008_AddQuestionnaireRFIAsPhaseOfEvents() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0008_AddQuestionnaireRFIAsPhaseOfEvents";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Select the RFI'S
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select QUESTIONNAIRE FOR RFI'S IS ABOUT 'Phases of Events'";
			    ...
			    for(WebElement option : options) {
			    	if("phases of events".equals(option.getText())){
			    			option.setSelected();
				...
				// Assertion: Verify that the RFI For 'Phases of events' gets selected
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="RFI for 'Phases of Events'";
				...
				if(GlobalVariables.oElement.getText().equalsIgnoreCase("Phases of Events")){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0008_AddQuestionnaireRFIAsPhaseOfEvents();
