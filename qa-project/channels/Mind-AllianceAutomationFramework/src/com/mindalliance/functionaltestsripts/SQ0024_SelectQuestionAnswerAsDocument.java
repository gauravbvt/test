...
public class SQ0024_SelectQuestionAnswerAsDocument {
	public SQ0024_SelectQuestionAnswerAsDocument() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0024_SelectQuestionAnswerAsDocument";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Select Question answer as 'document' ";
			    ...
			    for(WebElement option : options) {
			    	if("document".equals(option.getText())){
			    			option.setSelected();
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0024_SelectQuestionAnswerAsDocument();
