...
public class SQ0014_AddQuestionnaireRFIAsTransmissionMedia {
	public SQ0014_AddQuestionnaireRFIAsTransmissionMedia() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0014_AddQuestionnaireRFIAsTransmissionMedia";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0014_AddQuestionnaireRFIAsTransmissionMedia();
