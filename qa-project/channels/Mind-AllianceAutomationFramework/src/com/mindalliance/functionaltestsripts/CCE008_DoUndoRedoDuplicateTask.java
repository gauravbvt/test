...
public class CCE008_DoUndoRedoDuplicateTask 
{
	public CCE008_DoUndoRedoDuplicateTask() {
		try {
			GlobalVariables.sTestCaseId = "CCE008_DoUndoRedoDuplicateTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Do Undo Redo Duplicate Task"), "New");
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					// Do- Click 'Duplicate task' option under 'Actions' pop up menu of Task section
					GlobalVariables.iStepNo++ ;
					...
					// Undo- Click 'Undo duplicate task' option under 'Actions' pop up menu of Task section
					GlobalVariables.iStepNo++ ;
					...
					// Redo- Click 'Redo duplicate task' option under 'Actions' pop up menu of Task section
					GlobalVariables.iStepNo++ ;
					...
					Thread.currentThread();
					Thread.sleep(3000);
					// ASSERTION: When clicked on 'Redo add new task' option, the respective task should be created again in Information Sharing Plan
					count = 0;
					GlobalVariables.oElement = GlobalVariables.oDriver.findElement(By.className("data-table"));
					tds = GlobalVariables.oElement.findElements(By.tagName("td"));
					for (WebElement td: tds){
					...
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						...
						GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Task Count = 2' "+" Actual 'Task Count = '" + count +"'";
				    	// Write Results
						LogFunctions.writeLogs(GlobalVariables.sDescription + "" + GlobalVariables.sFailed);
						LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sFailed, 
								GlobalVariables.sBlank, GlobalVariables.sVerifyError);
					...
					Thread.currentThread();
					Thread.sleep(3000);
					ApplicationFunctionLibrary.MouseOverAndClick(GlobalVariables.plan.get("sXpathActionsPopUpMenu"), "Remove this segment");
	...
	public static void main(String args[]) {
		try {
			...
			new CCE008_DoUndoRedoDuplicateTask();
