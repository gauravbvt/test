...
public class TFP074_AddInfoReceiveSendAttachmentAsPolicy 
{
	public TFP074_AddInfoReceiveSendAttachmentAsPolicy(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP074_AddInfoReceiveSendAttachmentAsPolicy";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Attachment As Policy"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP074_AddInfoReceiveSendAttachmentAsPolicy();
