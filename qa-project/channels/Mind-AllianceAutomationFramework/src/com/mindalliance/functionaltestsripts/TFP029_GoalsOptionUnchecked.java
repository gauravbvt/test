...
public class TFP029_GoalsOptionUnchecked 
{
	public TFP029_GoalsOptionUnchecked(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP029_GoalsOptionUnchecked";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP029_GoalsOptionUnchecked();
