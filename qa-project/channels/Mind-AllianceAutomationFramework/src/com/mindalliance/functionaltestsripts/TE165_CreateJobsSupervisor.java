...
public class TE165_CreateJobsSupervisor 
{
	public TE165_CreateJobsSupervisor(){
		try {
			GlobalVariables.sTestCaseId = "TE165_CreateJobsSupervisor";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					// Enter  Agent details
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Supervisor Created";
					String Agent="Agent 1";
					String Title="Title 1";
					String Role ="Role 1";
					String Jurisdiction ="Jurisdiction 1";
					String Supervisor="Supervisor 1";
					if (GlobalVariables.sBrowser.equals("Internet Explorer")) {
				    ...
				    GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath("//table[contains(@class,'data-table')]"));
					if(GlobalVariables.oElement.getText().contains(Agent)){
						// Write Results
						LogFunctions.writeLogs(GlobalVariables.sDescription);
						LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
								GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					GlobalVariables.oDriver.findElement(By.xpath("//img[contains(@src,'float-bar-close.png')]")).click();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					Thread.sleep(3000);
					// Remove Organization
					GlobalVariables.oDriver.findElement(By.linkText("Remove expectation")).click();
					// WebElement Synchronization
					Thread.currentThread();
					Thread.sleep(2000);
					GlobalVariables.oDriver.findElement(By.xpath("//img[contains(@src,'float-bar-close.png')]")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new TE165_CreateJobsSupervisor();
