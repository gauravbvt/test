...
public class CP022_ShowReceivedMessages
{
	public CP022_ShowReceivedMessages(){
		try {
			GlobalVariables.sTestCaseId = "CP022_ShowReceivedMessages";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Assertion: Verify that show received link changes to show sent 
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Show received link changes to show sent";
				...
				if (GlobalVariables.oElement.getText().equals("show sent")) {
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
			    	...
			    	GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'show sent' "+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
	...
	public static void main(String args[]) {
		try {
			...
			new CP022_ShowReceivedMessages();
