...
public class CCE002_DoUndoRedoRemoveSegment 
{
	public CCE002_DoUndoRedoRemoveSegment() {
		try {
			GlobalVariables.sTestCaseId = "CCE002_DoUndoRedoRemoveSegment";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Do Undo Redo Remove This Segment"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Do- Click on 'Remove this segment' under 'Actions' pop up menu
				GlobalVariables.iStepNo++ ;
				...
				for(WebElement option : options) {
					...
					if(GlobalVariables.testData.get("Segment For Do Undo Redo Remove This Segment").equals(option.getText())){
				...
				// Undo- Click on 'Undo remove this segment' under 'Actions' pop up menu
				GlobalVariables.iStepNo++ ;
				...
				Thread.currentThread();
				Thread.sleep(5000);
				// ASSERTION: When clicked on 'Undo update segment' option, the added Goal should be deleted from Goals pop up window
				GlobalVariables.oDropDown = new Select(GlobalVariables.oDriver.findElement(By.name("select-segment:sg-sel")));
				options = GlobalVariables.oDropDown.getOptions();
				GlobalVariables.bIsSuccess = Boolean.TRUE;
				for(WebElement option : options){
					GlobalVariables.sStrCheck=option.getText();
					if("Segment For Do Undo Redo Remove This Segment".equals(option.getText())){
						GlobalVariables.bIsSuccess = Boolean.FALSE;
						option.setSelected();
						// WebElement Synchronization
						Thread.currentThread();
				...
				// Redo- Click on 'Redo remove this segment' under 'Actions' pop up menu
				GlobalVariables.iStepNo++ ;
	 ...
	 public static void main(String args[]) {
			try {
				...
				new CCE002_DoUndoRedoRemoveSegment();
