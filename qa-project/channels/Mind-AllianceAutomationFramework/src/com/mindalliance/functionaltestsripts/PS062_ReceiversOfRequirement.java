...
public class PS062_ReceiversOfRequirement 
{
	public PS062_ReceiversOfRequirement(){
		
		try {
			GlobalVariables.sTestCaseId = "PS062_ReceiversOfRequirement";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathReceiversTabOfRequirement")));
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("Receivers"))){
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
					...
					GlobalVariables.sVerifyError ="Verification Failed Expected " + GlobalVariables.testData.get("Receivers") + " Actual "+GlobalVariables.oElement.getText();
					// Write Results
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new PS062_ReceiversOfRequirement();
