...
public class TE110_DeletePhase 
{
	public TE110_DeletePhase() {
		try {
			GlobalVariables.sTestCaseId = "TE110_DeletePhase";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Delete New Phase"));
					...
					// Delete an Phase
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Phase Deleted";
