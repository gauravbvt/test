	...
	public TE007_AddAgentCategory() {
		try{
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oDriver.findElement(By.name("entity:content:mo:aspect:mo-details:types:typesDiv:types:1:typeContainer:newType")).clear();
				// WebElement Synchronization
				Thread.currentThread();
				Thread.sleep(1000);
				...
				Thread.currentThread();
				Thread.sleep(2000);
				if(GlobalVariables.oElement.getText().equals(sAgentCategory)){
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
		    		...
		    		GlobalVariables.sVerifyError="Verification Failed. Expected '"+sAgentCategory+"' Actual '"+GlobalVariables.oElement.getText()+"'";
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
