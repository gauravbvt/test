...
public class TFP108_LocationAsCommunicatedInInfo 
{
	public TFP108_LocationAsCommunicatedInInfo(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP108_LocationAsCommunicatedInInfo";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment Location As InInfo"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				// Get a handle to the open alert, prompt or confirmation
	...
	public static void main(String args[]) {
		try {
			...
			new TFP108_LocationAsCommunicatedInInfo();
