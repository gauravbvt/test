...
public class TFP082_AddInfoReceiveSendIssueTypeOption 
{
	public TFP082_AddInfoReceiveSendIssueTypeOption(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP082_AddInfoReceiveSendIssueTypeOption";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP082_AddInfoReceiveSendIssueTypeOption();
