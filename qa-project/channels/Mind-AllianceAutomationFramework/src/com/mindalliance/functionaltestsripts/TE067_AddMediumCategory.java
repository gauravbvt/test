...
public class TE067_AddMediumCategory 
{
	public TE067_AddMediumCategory() {
		try{
			GlobalVariables.sTestCaseId = "TE067_AddMediumCategory";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				{
					GlobalVariables.sVerifyError="Verification Failed. Expected '" + GlobalVariables.testData.get("Category 1")+"' Actual '"+GlobalVariables.oElement.getText()+"'";
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
