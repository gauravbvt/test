...
public class PS112_ViewAllSituationRequirement 
{
	public PS112_ViewAllSituationRequirement(){		
		try {
			GlobalVariables.sTestCaseId = "PS112_ViewAllSituationRequirement";
	...
	public static void main(String args[]) {
		try {
			...
			new PS112_ViewAllSituationRequirement();
