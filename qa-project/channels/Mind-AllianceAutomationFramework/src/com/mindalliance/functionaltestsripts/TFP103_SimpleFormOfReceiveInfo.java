...
public class TFP103_SimpleFormOfReceiveInfo 
{
	public TFP103_SimpleFormOfReceiveInfo(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP103_SimpleFormOfReceiveInfo";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("showSimpleForm"))){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected '"+GlobalVariables.viewElements.get("showSimpleForm")+"' "+" Actual " + GlobalVariables.oElement.getText();
			    	// Write Results
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP103_SimpleFormOfReceiveInfo();
