...
public class TE103_DelteEventAttachment 
{
	public TE103_DelteEventAttachment(){
		try {
			GlobalVariables.sTestCaseId = "TE103_DelteEventAttachment";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Delete Attachment Of Event"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Delete Attachment
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Attachment Deleted";
				...
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.assertion.get("sXpathDeleteEventAttachmentAssertion")));
	...
	public static void main(String args[]) {
		try {
			...
			new TE103_DelteEventAttachment();
