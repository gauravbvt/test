...
public class SQ0009_AddQuestionnaireRFIAsPlaces {
	public SQ0009_AddQuestionnaireRFIAsPlaces() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0009_AddQuestionnaireRFIAsPlaces";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0009_AddQuestionnaireRFIAsPlaces();
