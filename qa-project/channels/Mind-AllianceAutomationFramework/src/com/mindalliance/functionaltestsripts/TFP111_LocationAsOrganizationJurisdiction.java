...
public class TFP111_LocationAsOrganizationJurisdiction 
{
	public TFP111_LocationAsOrganizationJurisdiction(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP111_LocationAsOrganizationJurisdiction";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment LocationAsOrganizationJurisdiction"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Select LocationAsOrganizationJurisdiction Location
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="LocationAsOrganizationJurisdiction Selected";
			    ...
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Agents jurisdiction' "+" Actual "+GlobalVariables.oElement.getText();
					// Write Results
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP111_LocationAsOrganizationJurisdiction();
