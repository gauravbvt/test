...
public class TFP053_AddInfoReceiveSendInformation 
{
	public TFP053_AddInfoReceiveSendInformation(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP053_AddInfoReceiveSendInformation";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP053_AddInfoReceiveSendInformation();
