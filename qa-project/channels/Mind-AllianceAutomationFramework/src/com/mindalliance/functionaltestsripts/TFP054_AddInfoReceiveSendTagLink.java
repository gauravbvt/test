...
public class TFP054_AddInfoReceiveSendTagLink 
{
	public TFP054_AddInfoReceiveSendTagLink(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP054_AddInfoReceiveSendTagLink";
...
//				GlobalVariables.oDriver.findElement(By.linkText("Add info received")).click();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP054_AddInfoReceiveSendTagLink();
