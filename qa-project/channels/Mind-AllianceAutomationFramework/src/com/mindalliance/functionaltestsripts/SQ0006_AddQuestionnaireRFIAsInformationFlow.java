...
public class SQ0006_AddQuestionnaireRFIAsInformationFlow {
	public SQ0006_AddQuestionnaireRFIAsInformationFlow() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0006_AddQuestionnaireRFIAsInformationFlow";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0006_AddQuestionnaireRFIAsInformationFlow();
