...
public class TFP065_AddInfoReceiveSendChannelsOptions 
{
	public TFP065_AddInfoReceiveSendChannelsOptions(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP065_AddInfoReceiveSendChannelsOptions";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP065_AddInfoReceiveSendChannelsOptions();
