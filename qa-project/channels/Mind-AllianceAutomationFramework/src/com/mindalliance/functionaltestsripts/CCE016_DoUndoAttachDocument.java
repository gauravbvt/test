...
public class CCE016_DoUndoAttachDocument 
{
	public CCE016_DoUndoAttachDocument() {
		try {
			GlobalVariables.sTestCaseId = "CCE016_DoUndoAttachDocument";
	...
	public static void main(String args[]) {
		try {
			...
			new CCE016_DoUndoAttachDocument();
