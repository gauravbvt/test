...
public class TFP034_TaskAttachmentAsPolicy 
{
	public TFP034_TaskAttachmentAsPolicy(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP034_TaskAttachmentAsPolicy";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP034_TaskAttachmentAsPolicy();
