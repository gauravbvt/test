...
public class TE162_CreateJobsRole 
{
	public TE162_CreateJobsRole() {
		try {
...
//					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Role"));
				    ...
				    GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.linkText(Role));
