...
public class CCE026_DoUndoRedoBreakUpFlow
{
	public CCE026_DoUndoRedoBreakUpFlow() {
		try {
			GlobalVariables.sTestCaseId = "CCE026_DoUndoRedoBreakUpFlow";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Do Undo Redo Break Up Flow"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
			    ...
			    for(WebElement option : options) {
			    	if(option.getText().equals("Segment For Do Undo Redo Break Up Flow")){
			    			option.setSelected();
			    			break;
			    	}
			    }
...
//				alert.accept();
    ...
    public static void main(String args[]) {
		try {
			...
			new CCE026_DoUndoRedoBreakUpFlow();
