...
public class TFP016_AddRole 
{
	public TFP016_AddRole(){
    	try {
    		GlobalVariables.sTestCaseId = "TFP016_AddRole";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Add Role To Task"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				GlobalVariables.oDriver.findElement(By.name("segment:part:role:name")).click();
