...
public class SQ0013_AddQuestionnaireRFIAsTasks {
	public SQ0013_AddQuestionnaireRFIAsTasks() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0013_AddQuestionnaireRFIAsTasks";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0013_AddQuestionnaireRFIAsTasks();
