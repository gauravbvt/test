...
public class TE047_NamedLocaleAttachment 
{
	public TE047_NamedLocaleAttachment(){
		try {
			GlobalVariables.sTestCaseId = "TE047_NamedLocaleAttachment";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Attach Named File To Locale"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new TE047_NamedLocaleAttachment();
