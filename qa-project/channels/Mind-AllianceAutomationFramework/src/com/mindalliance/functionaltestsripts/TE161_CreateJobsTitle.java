...
public class TE161_CreateJobsTitle 
{
	public TE161_CreateJobsTitle() {
		try {
			GlobalVariables.sTestCaseId = "TE161_CreateJobsTitle";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					// Enter  Agent details
					GlobalVariables.iStepNo++;
					GlobalVariables.sDescription="Title Entered";
				    ...
				    GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("entity:mo:aspect:mo-details:tabContainer:tabs:panel:jobsDiv:jobs:0:title"));
					if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("Title 1"))){
						// Write Results
						LogFunctions.writeLogs(GlobalVariables.sDescription);
						LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
								GlobalVariables.sBlank, GlobalVariables.sBlank);
						...
						GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Title 1' "+" Actual "+GlobalVariables.oElement.getText();
						// Write Results
