...
public class TFP008_ShowOrHideTaskDetails 
{
	public TFP008_ShowOrHideTaskDetails(){
    	try {
    		GlobalVariables.sTestCaseId = "TFP008_ShowOrHideTaskDetails";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP008_ShowOrHideTaskDetails();
