...
public class PS036_RequirementDescription 
{
	public PS036_RequirementDescription(){
		
		try {
			GlobalVariables.sTestCaseId = "PS036_RequirementDescription";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("Requirement Description"))){
					...
					GlobalVariables.sVerifyError="Verification Failed Expected '"+GlobalVariables.testData.get("Requirement Description")+"' Actual "+GlobalVariables.oElement.getText();
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
	...
	public static void main(String args[]) {
		try {
			...
			new PS036_RequirementDescription();
