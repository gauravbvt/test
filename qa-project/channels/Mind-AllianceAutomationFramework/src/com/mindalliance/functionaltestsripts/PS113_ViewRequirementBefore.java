...
public class PS113_ViewRequirementBefore 
{
	public PS113_ViewRequirementBefore(){		
		try {
			GlobalVariables.sTestCaseId = "PS113_ViewRequirementBefore";
	...
	public static void main(String args[]) {
		try {
			...
			new PS113_ViewRequirementBefore();
