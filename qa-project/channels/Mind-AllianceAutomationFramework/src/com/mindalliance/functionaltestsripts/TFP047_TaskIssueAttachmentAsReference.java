...
public class TFP047_TaskIssueAttachmentAsReference 
{
	public TFP047_TaskIssueAttachmentAsReference(){
    	try {
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Issue Attachment As Reference"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP047_TaskIssueAttachmentAsReference();
