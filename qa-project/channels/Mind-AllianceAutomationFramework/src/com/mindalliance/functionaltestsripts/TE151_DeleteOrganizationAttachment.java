...
public class TE151_DeleteOrganizationAttachment 
{
	public TE151_DeleteOrganizationAttachment() {
		try {
			GlobalVariables.sTestCaseId = "TE151_DeleteOrganizationAttachment";
	...
	public static void main(String args[]) {
		try {
			...
			new TE151_DeleteOrganizationAttachment();
