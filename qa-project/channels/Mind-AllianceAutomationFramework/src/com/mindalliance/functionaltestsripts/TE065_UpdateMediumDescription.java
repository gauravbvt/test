...
public class TE065_UpdateMediumDescription 
{
	public TE065_UpdateMediumDescription() {
		try{
			GlobalVariables.sTestCaseId = "TE065_UpdateMediumDescription";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Medium Description Updated";
				...
				Thread.sleep(1000);
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.name("entity:mo:aspect:mo-details:description"));
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("This is an Description")))
				{
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
				...
				{
					GlobalVariables.sVerifyError="Verification Failed. Expected '" + GlobalVariables.testData.get("This is an Description")+"' Actual '"+GlobalVariables.oElement.getText()+"'";
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
	...
	public static void main(String args[]) {
		try {
			...
			new TE065_UpdateMediumDescription();
