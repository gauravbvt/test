...
public class CCE012_DoUndoRedoConnectFlow
{
	public CCE012_DoUndoRedoConnectFlow() {
		try {
			GlobalVariables.sTestCaseId = "CCE012_DoUndoRedoConnectFlow";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Do Undo Redo Connect Flow"));
...
//					alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new CCE012_DoUndoRedoConnectFlow();
