...
public class TE049_AttachInvalidURLToLocale 
{
	public TE049_AttachInvalidURLToLocale(){
		try {
			GlobalVariables.sTestCaseId = "TE049_AttachInvalidURLToLocale";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Attach Invalid URL To Locale"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			...
			new TE049_AttachInvalidURLToLocale();
