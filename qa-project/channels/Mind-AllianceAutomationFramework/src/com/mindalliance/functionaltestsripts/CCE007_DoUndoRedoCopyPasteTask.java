...
public class CCE007_DoUndoRedoCopyPasteTask
{
	public CCE007_DoUndoRedoCopyPasteTask() {
		try {
			GlobalVariables.sTestCaseId = "CCE007_DoUndoRedoCopyPasteTask";
			...
			GlobalVariables.bIsSuccess = ApplicationFunctionLibrary.login();
				if (GlobalVariables.bIsSuccess) {
					...
					ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Do Undo Redo Copy Paste Task"), "New");
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
							GlobalVariables.sBlank, GlobalVariables.sBlank);
				    ...
				    for(WebElement option : options) {
				    	if("Segment For Do Undo Redo Copy Paste Task".equals(option.getText())){
				    			option.setSelected();
				    			break;
				    	}
				    }
	...
	public static void main(String args[]) {
		try {
			...
			new CCE007_DoUndoRedoCopyPasteTask();
