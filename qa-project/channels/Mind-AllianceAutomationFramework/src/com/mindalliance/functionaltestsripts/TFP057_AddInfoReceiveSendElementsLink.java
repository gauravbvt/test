...
public class TFP057_AddInfoReceiveSendElementsLink 
{
	public TFP057_AddInfoReceiveSendElementsLink(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP057_AddInfoReceiveSendElementsLink";
	...
	public static void main(String args[]) {
		try {
			...
			new TFP057_AddInfoReceiveSendElementsLink();
