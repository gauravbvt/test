...
public class CCE021_DoUndoRedoSetTaskFromCopy 
{
	public CCE021_DoUndoRedoSetTaskFromCopy() {
		try {
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Do Undo Redo Set Task From Copy"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    for(WebElement option : options) {
			    	if(option.getText().equals("Segment For Do Undo Redo Set Task From Copy")){
			    			option.setSelected();
			    			break;
			    	}
			    }
    ...
    public static void main(String args[]) {
		try {
			...
			new CCE021_DoUndoRedoSetTaskFromCopy();
