...
public class SQ0007_AddQuestionnaireRFIAsOrganization {
	public SQ0007_AddQuestionnaireRFIAsOrganization() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0007_AddQuestionnaireRFIAsOrganization";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0007_AddQuestionnaireRFIAsOrganization();
