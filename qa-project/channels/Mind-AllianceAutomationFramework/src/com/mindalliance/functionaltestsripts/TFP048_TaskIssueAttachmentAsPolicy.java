...
public class TFP048_TaskIssueAttachmentAsPolicy 
{
	public TFP048_TaskIssueAttachmentAsPolicy(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP048_TaskIssueAttachmentAsPolicy";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Issue Attachment As Policy"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				Thread.sleep(2000);
	...
	public static void main(String args[]) {
		try {
			...
			new TFP048_TaskIssueAttachmentAsPolicy();
