...
public class HP007_InformationShringModelLink 
{
	public HP007_InformationShringModelLink(){
    	try {
			GlobalVariables.sTestCaseId = "HP007_InformationShringModelLink";
    ...
    public static void main(String args[]) {
		try {
			...
			new HP007_InformationShringModelLink();
