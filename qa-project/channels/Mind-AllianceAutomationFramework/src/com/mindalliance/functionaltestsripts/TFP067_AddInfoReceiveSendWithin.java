...
public class TFP067_AddInfoReceiveSendWithin 
{
	public TFP067_AddInfoReceiveSendWithin(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP067_AddInfoReceiveSendWithin";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP067_AddInfoReceiveSendWithin();
