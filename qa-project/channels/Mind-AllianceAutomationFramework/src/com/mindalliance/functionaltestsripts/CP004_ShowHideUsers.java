...
public class CP004_ShowHideUsers
{
	public CP004_ShowHideUsers(){
		try {
			GlobalVariables.sTestCaseId = "CP004_ShowHideUsers";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				Thread.currentThread();
				Thread.sleep(1000);
				// Assertion: Verify that show all user link changes to hide inactive users
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Verify that show all user link changes to hide inactive users";
				GlobalVariables.oElement=GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathShowAllUsers")));
				if (GlobalVariables.oElement.getText().equals(GlobalVariables.viewElements.get("hideInactiveUsers"))) {
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected "+GlobalVariables.viewElements.get("hideInactiveUsers")+" Actual "+GlobalVariables.oElement.getText();
			    	// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
