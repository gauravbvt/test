...
public class TE063_UpdateMediumName 
{
	public TE063_UpdateMediumName() {
		try{
			GlobalVariables.sTestCaseId = "TE063_UpdateMediumName";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				for(int i=0;i<50;i++)
					GlobalVariables.oElement.sendKeys(Keys.BACK_SPACE);
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Medium 1"));
				...
				if(GlobalVariables.oElement.getText().equals(GlobalVariables.testData.get("Medium 1")))
				{
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
					LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
				...
				{
					GlobalVariables.sVerifyError="Verification Failed. Expected '"+GlobalVariables.testData.get("Medium 1")+"' Actual '"+GlobalVariables.oElement.getText()+"'";
					// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
