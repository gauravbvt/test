...
public class TE070_ViewAllTypesOfMedium 
{
	public TE070_ViewAllTypesOfMedium() {
		try{
			...
			if (GlobalVariables.bIsSuccess) {
				...
				// Click on View all types
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="View all types of medium";
				GlobalVariables.oDriver.findElement(By.xpath(GlobalVariables.plan.get("sXpathViewAllTypesOfAddInfoSendNewMedium"))).click();
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TE070_ViewAllTypesOfMedium();
