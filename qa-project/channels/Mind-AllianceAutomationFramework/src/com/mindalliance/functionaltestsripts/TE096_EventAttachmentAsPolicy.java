...
public class TE096_EventAttachmentAsPolicy 
{
	public TE096_EventAttachmentAsPolicy(){
		try {
			GlobalVariables.sTestCaseId = "TE096_EventAttachmentAsPolicy";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				GlobalVariables.oElement.sendKeys(GlobalVariables.testData.get("Segment For Event Attachment As Policy"));
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="Event Attachment as Policy";
	...
	public static void main(String args[]) {
		try {
			...
			new TE096_EventAttachmentAsPolicy();
