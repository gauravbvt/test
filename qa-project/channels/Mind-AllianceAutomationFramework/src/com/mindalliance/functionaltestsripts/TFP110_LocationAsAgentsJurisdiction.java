...
public class TFP110_LocationAsAgentsJurisdiction 
{
	public TFP110_LocationAsAgentsJurisdiction(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP110_LocationAsAgentsJurisdiction";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment LocationAsAgentsJurisdiction"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
				...
				// Select AgentsJurisdiction Location
				GlobalVariables.iStepNo++;
				GlobalVariables.sDescription="AgentsJurisdiction Selected";
...
//				alert.accept();
	...
	public static void main(String args[]) {
		try {
			...
			new TFP110_LocationAsAgentsJurisdiction();
