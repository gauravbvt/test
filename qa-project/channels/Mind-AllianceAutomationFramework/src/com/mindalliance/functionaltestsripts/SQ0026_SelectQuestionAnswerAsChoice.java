...
public class SQ0026_SelectQuestionAnswerAsChoice {
	public SQ0026_SelectQuestionAnswerAsChoice() {
		try{		
			
			GlobalVariables.sTestCaseId = "SQ0026_SelectQuestionAnswerAsChoice";
	...
	public static void main(String args[]) {
		try {
			...
			new SQ0026_SelectQuestionAnswerAsChoice();
