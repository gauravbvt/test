...
public class TE136_OrganizationDescription 
{
	public TE136_OrganizationDescription() {
		try {
			GlobalVariables.sTestCaseId = "TE136_OrganizationDescription";
	...
	public static void main(String args[]) {
		try {
			...
			new TE136_OrganizationDescription();
