...
public class TE052_UpdateLocaleIsWithin 
{
	public TE052_UpdateLocaleIsWithin() {
		try{
			
			GlobalVariables.sTestCaseId = "TE052_UpdateLocaleIsWithin";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				if(GlobalVariables.oElement.getValue().equals(GlobalVariables.testData.get("IsWithin Info"))) {
					...
					GlobalVariables.sVerifyError="Verification Failed. Expected '"+GlobalVariables.testData.get("IsWithin Info")+"' Actual '"+GlobalVariables.oElement.getValue()+"'";
	    			// Write Results
					LogFunctions.writeLogs(GlobalVariables.sDescription);
	...
	public static void main(String args[]) {
		try {
			...
			new TE052_UpdateLocaleIsWithin();
