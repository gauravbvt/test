...
public class TFP107_LocationAsCommunicated 
{
	public TFP107_LocationAsCommunicated(){
    	try {
    		
    		GlobalVariables.sTestCaseId = "TFP107_LocationAsCommunicated";
			...
			if (GlobalVariables.bIsSuccess) {
				...
				ApplicationFunctionLibrary.addSegment(GlobalVariables.testData.get("Segment For Task Communicated Location"), "New");
				// Write Results
				LogFunctions.writeLogs(GlobalVariables.sDescription);
				LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
						GlobalVariables.sBlank, GlobalVariables.sBlank);
			    ...
			    // Assertion: Verify that Communicated Location get selected.
			    if(GlobalVariables.bIsSuccess==Boolean.TRUE){
					...
					GlobalVariables.sVerifyError ="Verification Failed "+"Expected 'Communicated' "+" Actual "+GlobalVariables.oElement.getText();
					// Write Results
	...
	public static void main(String args[]) {
		try {
			...
			new TFP107_LocationAsCommunicated();
