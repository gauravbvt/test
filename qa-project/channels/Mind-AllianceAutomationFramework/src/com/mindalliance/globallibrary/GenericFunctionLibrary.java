...
public class GenericFunctionLibrary {
	...
	public static void loadObjectRepository() {
		try {
			...
			GlobalVariables.plan.put("sXpathReceiveInfoAddNewIssue",oXmlElePlanPage.getElementsByTagName("xPathReceiveInfoAddNewIssue").item(0).getChildNodes().item(0).getNodeValue());
			GlobalVariables.plan.put("sXpathReceiveInfoIssueMenu",oXmlElePlanPage.getElementsByTagName("xPathReceiveInfoIssueMenu").item(0).getChildNodes().item(0).getNodeValue());
			...
			GlobalVariables.plan.put("sXpathLocaleWithSpecialCharacters",oXmlElePlanPage.getElementsByTagName("xPathLocaleWithSpecialCharacters").item(0).getChildNodes().item(0).getNodeValue());
			GlobalVariables.plan.put("sXpathLegend",oXmlElePlanPage.getElementsByTagName("xPathLegend").item(0).getChildNodes().item(0).getNodeValue());
			...
			GlobalVariables.plan.put("sXpathCopyTaskAttachment",oXmlElePlanPage.getElementsByTagName("xPathCopyTaskAttachment").item(0).getChildNodes().item(0).getNodeValue());
			...
			// Assertions
			GlobalVariables.assertion.put("sXpathAssertionAddQuestion",oXmlElePlanPage.getElementsByTagName("xPathAssertionAddQuestion").item(0).getChildNodes().item(0).getNodeValue());
			...
			GlobalVariables.viewElements.put("elements",oXmlEleViewElements.getElementsByTagName("elements").item(0).getChildNodes().item(0).getNodeValue());
			GlobalVariables.viewElements.put("allEventsInThePlan",oXmlEleViewElements.getElementsByTagName("allEventsInThePlan").item(0).getChildNodes().item(0).getNodeValue());
			...
			GlobalVariables.viewElements.put("network1",oXmlEleViewElements.getElementsByTagName("network1").item(0).getChildNodes().item(0).getNodeValue());
