...
public class REST006_ISPRelease extends TestCase {
	...
	public static void testISPPlanRelease(){
		try {
			...
			GlobalVariables.testCaseId = "REST006_ISPRelease";
			...
			System.out.println(GlobalVariables.steps+") Test Case : REST006_ISPRelease Execution Started");
			LogFunctions.logDescription(GlobalVariables.steps + ") REST006_ISPRelease Execution Started");
			...
			// Execution Completed
			GlobalVariables.steps++;
			System.out.println(GlobalVariables.steps+") Test Case : REST006_ISPRelease Execution Completed");
			System.out.println("");
			LogFunctions.logDescription(GlobalVariables.steps+ ") Test Case : REST006_ISPRelease Execution Completed");
			System.out.println("");
