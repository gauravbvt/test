...
public class GlobalVariables {
	...
	public static boolean bIsEnabled = false;
	...
	// TestData
	public static String sLoginURL = "http://192.168.1.128:8081";
	public static String sUsername = "quamar";
	public static String sPassword = "@test123";
	public static String sBrowser;
	public static String sInternalErrorPageTitle;
