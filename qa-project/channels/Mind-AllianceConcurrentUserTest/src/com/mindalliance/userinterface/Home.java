...
public class Home extends JFrame implements ActionListener, ItemListener{
	...
	private void initComponents() {
		...
		add(getJButton1(), new Constraints(new Leading(1136, 12, 12), new Leading(369, 12, 12)));
	...
	public void updateProgressBar(int percent) {
		...
		jProgressBarStatus.setString("Completed: " + Integer.toString(percent));
	...
	public void executeTestCases(Vector arrayOfTestCaseId) {
		int totalExecute;
		try {
			Class<?> cls;
			cnt = 0;
			...
			jProgressBarStatus.setMaximum(count);
