...
public class MACU0017_addSentInfo 
{
	public MACU0017_addSentInfo()
	{
		try
		{
			GlobalVariables.sTestCaseId = "MACU0017_addSentInfo";
			...
			GlobalVariables.oDriverFirst.findElement(By.xpath("/html/body/form/span/div/div[3]/div[3]/div/a/span")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			Thread.currentThread();
			Thread.sleep(3000);
			ApplicationFunctionLibrary.MouseOverAndClick("/html/body/form/span/div/div[3]/div[3]/div[2]/div/div/span/span/span/span","Hide details",GlobalVariables.oDriverFirst,GlobalVariables.oElementFirst);
			// WebElement Synchronization
			Thread.currentThread();
			Thread.sleep(8000);
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Receive Info";
			GlobalVariables.oDriverSecond.findElement(By.xpath("/html/body/form/span/div/div[3]/div[3]/div/a/span")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
