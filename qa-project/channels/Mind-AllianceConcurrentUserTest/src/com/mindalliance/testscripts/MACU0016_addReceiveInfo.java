...
public class MACU0016_addReceiveInfo 
{
	public  MACU0016_addReceiveInfo()
	{
		try
		{
			GlobalVariables.sTestCaseId = "MACU0016_addReceiveInfo";
			...
			// click on add receive info User A
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Receive Info";
			GlobalVariables.oDriverFirst.findElement(By.xpath("/html/body/form/span/div/div[3]/div[2]/div/a/span")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			Thread.currentThread();
			Thread.sleep(3000);
			ApplicationFunctionLibrary.MouseOverAndClick("/html/body/form/span/div/div[3]/div[2]/div[2]/div/div/span/span/span/span","Hide details",GlobalVariables.oDriverFirst,GlobalVariables.oElementFirst);
			// WebElement Synchronization
			Thread.currentThread();
			Thread.sleep(8000);
			
			// click on add receive info User B
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Receive Info";
			GlobalVariables.oDriverSecond.findElement(By.xpath("/html/body/form/span/div/div[3]/div[2]/div/a/span")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
