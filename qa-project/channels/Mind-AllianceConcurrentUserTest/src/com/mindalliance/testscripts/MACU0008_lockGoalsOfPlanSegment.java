...
public class MACU0008_lockGoalsOfPlanSegment 
{
	public MACU0008_lockGoalsOfPlanSegment()
	{
		try{
			GlobalVariables.sTestCaseId = "MACU0008_lockGoalsOfPlanSegment";
			...
			// Click on Goals under show pop up menu of About plan segment of User A
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Goals";
			ApplicationFunctionLibrary.MouseOverAndClick("/html/body/form/div[5]/div/div[2]/div/div/span/span/span/span", "Goals",GlobalVariables.oDriverFirst,GlobalVariables.oElementFirst);
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Goals";
			ApplicationFunctionLibrary.MouseOverAndClick("/html/body/form/div[5]/div/div[2]/div/div/span/span/span/span", "Goals",GlobalVariables.oDriverSecond,GlobalVariables.oElementSecond);
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			GlobalVariables.iStepNo++ ;
			GlobalVariables.sDescription = "Lock generated for Goals";
	...
	public static void main(String args[]) {
		try {
			new MACU0008_lockGoalsOfPlanSegment();
		} 
