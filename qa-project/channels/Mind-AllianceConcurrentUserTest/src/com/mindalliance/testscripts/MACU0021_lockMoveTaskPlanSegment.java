...
public class MACU0021_lockMoveTaskPlanSegment 
{
	public MACU0021_lockMoveTaskPlanSegment()
	{
		try
		{
			GlobalVariables.sTestCaseId = "MACU0021_lockMoveTaskPlanSegment";
			...
			// Click on Move tasks to segment... under Action pop up menu	
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Move task";
			ApplicationFunctionLibrary.MouseOverAndClick("//span[@class='menubar']/span[3]/span/span","Move tasks to segment...",GlobalVariables.oDriverFirst,GlobalVariables.oElementFirst);
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Move task";
			ApplicationFunctionLibrary.MouseOverAndClick("//span[@class='menubar']/span[3]/span/span","Move tasks to segment...",GlobalVariables.oDriverSecond,GlobalVariables.oElementSecond);
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			GlobalVariables.iStepNo++ ;
			GlobalVariables.sDescription = "Lock generated for Move task";
	...
	public static void main(String args[]) {
		try {
			new MACU0021_lockMoveTaskPlanSegment();
		} 
