...
public class MACU0010_lockRemoveSegment 
{
	public MACU0010_lockRemoveSegment()
	{
		try
		{
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Remove Segment Locked";
	...
	public static void main(String args[]) {
		try {
			new MACU0010_lockRemoveSegment();
		} 
