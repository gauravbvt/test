...
public class MACU0006_lockIndex 
{
	public MACU0006_lockIndex()
	{
		try
		{
			...
			GlobalVariables.oDriverFirst.findElement(By.linkText("Index")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
			...
			GlobalVariables.oElementSecond.click();
		    // Click on "Index" option under 'Show' pop up menu
			GlobalVariables.oDriverSecond.findElement(By.linkText("Index")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
