...
public class MACU0005_lockWhosWho
{
	public MACU0005_lockWhosWho()
	{
		try
		{
			...
			GlobalVariables.oDriverFirst.findElement(By.linkText("Who's who")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
		    ...
		    // Click on "Who's who" option under 'Show' pop up menu
			GlobalVariables.oDriverSecond.findElement(By.linkText("Who's who")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
