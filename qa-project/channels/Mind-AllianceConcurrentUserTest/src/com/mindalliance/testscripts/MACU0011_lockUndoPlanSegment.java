...
public class MACU0011_lockUndoPlanSegment 
{
	public MACU0011_lockUndoPlanSegment()
	{
		try
		{
			...
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Undo update Segment";
			...
			// Assertion: Verifying lock on "Undo update segment" link for User B
			GlobalVariables.iStepNo++;
			GlobalVariables.sDescription="Undo update segment";
			ApplicationFunctionLibrary.isElementEnabled("Undo update segment", GlobalVariables.oDriverSecond, GlobalVariables.oElementSecond, "LinkText");
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			new MACU0011_lockUndoPlanSegment();
		} 
