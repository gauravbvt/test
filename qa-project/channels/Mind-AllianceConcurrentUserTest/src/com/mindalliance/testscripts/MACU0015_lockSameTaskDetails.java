...
public class MACU0015_lockSameTaskDetails
{
	public MACU0015_lockSameTaskDetails()
	{
		try
		{
			GlobalVariables.sTestCaseId = "MACU0015_lockSameTaskDetails";
			...
			Thread.currentThread();
			Thread.sleep(3000);	
			ApplicationFunctionLibrary.MouseOverAndClick("/html/body/form/span/div/div[3]/div/div/span[2]/span/span/span","Hide details", GlobalVariables.oDriverFirst,GlobalVariables.oElementFirst);	
			// WebElement Synchronization
			Thread.currentThread();
			Thread.sleep(3000);	
			...
			// ASSERTION: Lock should be generated
	...
	public static void main(String args[]) {
		try {
			new MACU0015_lockSameTaskDetails();
		} 
