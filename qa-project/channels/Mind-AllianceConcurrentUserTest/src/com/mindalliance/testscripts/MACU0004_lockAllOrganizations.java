...
public class MACU0004_lockAllOrganizations
{
	public MACU0004_lockAllOrganizations()
	{
		try
		{
			GlobalVariables.sTestCaseId = "MACU0004_lockAllOrganizations";
			...
			GlobalVariables.oDriverFirst.findElement(By.linkText("All organizations")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
		    ...
		    // Click on "All organizations" option under 'Show' pop up menu
			GlobalVariables.oDriverSecond.findElement(By.linkText("All organizations")).click();
			// Write Results
			LogFunctions.writeLogs(GlobalVariables.sDescription);
			LogFunctions.writeResults(GlobalVariables.sTestCaseId, GlobalVariables.iStepNo, GlobalVariables.sDescription, GlobalVariables.sPassed, 
					GlobalVariables.sBlank, GlobalVariables.sBlank);
	...
	public static void main(String args[]) {
		try {
			new MACU0004_lockAllOrganizations();
		} 
